...
const birdMap = {
    ...
    "Okarito Kiwi": "Okarito Kiwi(白眶几维)",
    ...
    "Grey-legged Tinamou": "Grey-legged Tinamou(灰腿穴䳍)",
    ...
    "Greylag Goose": "Greylag Goose(灰雁)",
    ...
    "Fuegian Steamer Duck": "Fuegian Steamer Duck(灰船鸭)",
    "Falkland Steamer Duck": "Falkland Steamer Duck(短翅船鸭)",
    "Chubut Steamer Duck": "Chubut Steamer Duck(白头船鸭)",
    ...
    "Mauritius Sheldgoose": "Mauritius Sheldgoose(毛里求斯雁)",
    "Reunion Sheldgoose": "Reunion Sheldgoose(留尼汪雁)",
    ...
    "Bronze-winged Duck": "Bronze-winged Duck(铜翅鸭)",
    ...
    "Amsterdam Wigeon": "Amsterdam Wigeon(阿岛鸭)",
    ...
    "Red-billed Teal": "Red-billed Teal(赤嘴鸭)",
    ...
    "Eurasian Teal": "Eurasian Teal(绿翅鸭)",
    "Green-winged Teal": "Green-winged Teal(美洲绿翅鸭)",
    ...
    "Mascarene Teal": "Mascarene Teal(毛里求斯鸭)",
    "Grey Teal": "Grey Teal(灰鸭)",
    "Chestnut Teal": "Chestnut Teal(栗胸鸭)",
    "Bernier's Teal": "Bernier's Teal(马岛鸭)",
    "Brown Teal": "Brown Teal(褐鸭)",
    "Auckland Teal": "Auckland Teal(奥岛鸭)",
    "Campbell Teal": "Campbell Teal(坎岛鸭)",
    ...
    "New Zealand Merganser": "New Zealand Merganser(奥克兰秋沙鸭)",
    ...
    "Black-billed Brushturkey": "Black-billed Brushturkey(黑嘴塚雉)",
    "Collared Brushturkey": "Collared Brushturkey(褐领塚雉)",
    ...
    "Biak Scrubfowl": "Biak Scrubfowl(比岛塚雉)",
    "Melanesian Megapode": "Melanesian Megapode(红斑塚雉)",
    "Vanuatu Megapode": "Vanuatu Megapode(瓦努阿图塚雉)",
    "New Guinea Scrubfowl": "New Guinea Scrubfowl(斑喉塚雉)",
    "Orange-footed Scrubfowl": "Orange-footed Scrubfowl(橙脚塚雉)",
    "Plain Chachalaca": "Plain Chachalaca(纯色小冠雉)",
    "Grey-headed Chachalaca": "Grey-headed Chachalaca(灰头小冠雉)",
    ...
    "Little Chachalaca": "Little Chachalaca(小冠雉)",
    ...
    "Yucatan Bobwhite": "Yucatan Bobwhite(黑喉齿鹑)",
    ...
    "Udzungwa Forest Partridge": "Udzungwa Forest Partridge(坦桑尼亚鹑)",
    ...
    "Grey-breasted Partridge": "Grey-breasted Partridge(灰胸山鹧鸪)",
    ...
    "Sage Grouse": "Sage Grouse(艾草松鸡)",
    "Gunnison Grouse": "Gunnison Grouse(小艾草松鸡)",
    ...
    "Grey Partridge": "Grey Partridge(灰山鹑)",
    ...
    "Common Pheasant": "Common Pheasant(雉鸡)",
    ...
    "Congo Peafowl": "Congo Peafowl(刚果孔雀)",
    "Indian Peafowl": "Indian Peafowl(蓝孔雀)",
    "Green Peafowl": "Green Peafowl(绿孔雀)",
    "Green-legged Partridge": "Green-legged Partridge(绿脚树鹧鸪)",
    ...
    "Grey Peacock-Pheasant": "Grey Peacock-Pheasant(灰孔雀雉)",
    ...
    "Grey Junglefowl": "Grey Junglefowl(灰原鸡)",
    ...
    "Grey Francolin": "Grey Francolin(灰鹧鸪)",
    ...
    "Grey-winged Francolin": "Grey-winged Francolin(灰翅鹧鸪)",
    ...
    "Chukar Partridge": "Chukar Partridge(石鸡)",
    ...
    "Grey-striped Spurfowl": "Grey-striped Spurfowl(灰纹鹧鸪)",
    ...
    "Grey-breasted Spurfowl": "Grey-breasted Spurfowl(彩鹧鸪)",
    ...
    "Satanic Nightjar": "Satanic Nightjar(环颈毛腿夜鹰)",
    ...
    "Plain-tailed Nighthawk": "Plain-tailed Nighthawk(巴伊亚夜鹰)",
    "Blackish Nightjar": "Blackish Nightjar(暗色夜鹰)",
    "Pygmy Nightjar": "Pygmy Nightjar(侏夜鹰)",
    "Pauraque": "Pauraque(帕拉夜鹰)",
    "Anthony's Nightjar": "Anthony's Nightjar(灌丛夜鹰)",
    ...
    "Least Poorwill": "Least Poorwill(中美夜鹰)",
    "Jamaican Poorwill": "Jamaican Poorwill(牙买加夜鹰)",
    ...
    "Grey Nightjar": "Grey Nightjar(普通夜鹰)",
    "Palau Nightjar": "Palau Nightjar(帕劳夜鹰)",
    "European Nightjar": "European Nightjar(欧夜鹰)",
    ...
    "Prigogine's Nightjar": "Prigogine's Nightjar(普氏夜鹰)",
    ...
    "Grey-rumped Treeswift": "Grey-rumped Treeswift(灰腰凤头雨燕)",
    ...
    "American Black Swift": "American Black Swift(黑雨燕)",
    ...
    "Giant Swiftlet": "Giant Swiftlet(瀑布雨燕)",
    "Plume-toed Swiftlet": "Plume-toed Swiftlet(毛趾金丝燕)",
    "Grey-rumped Swiftlet": "Grey-rumped Swiftlet(灰腰金丝燕)",
    ...
    "Christmas Swiftlet": "Christmas Swiftlet(圣诞岛金丝燕)",
    ...
    "Caroline Swiftlet": "Caroline Swiftlet(卡罗琳金丝燕)",
    ...
    "Edible-nest Swiftlet": "Edible-nest Swiftlet(爪哇金丝燕)",
    ...
    "Böhm's Spinetail": "Böhm's Spinetail(伯氏针尾雨燕)",
    ...
    "Grey-rumped Swift": "Grey-rumped Swift(淡腰雨燕)",
    ...
    "African Black Swift": "African Black Swift(非洲黑雨燕)",
    "Malagasy Black Swift": "Malagasy Black Swift(马岛黑雨燕)",
    "Fernando Po Swift": "Fernando Po Swift(费波黑雨燕)",
    ...
    "Grey-chinned Hermit": "Grey-chinned Hermit(灰颏隐蜂鸟)",
    ...
    "Flame-throated Sunangel": "Flame-throated Sunangel(小领蜂鸟)",
    ...
    "Letitia's Thorntail": "Letitia's Thorntail(铜色刺尾蜂鸟)",
    ...
    "Grey-bellied Comet": "Grey-bellied Comet(灰嘴彗星蜂鸟)",
    ...
    "Fiery-throated Metaltail": "Fiery-throated Metaltail(火喉辉尾蜂鸟)",
    ...
    "Golden-tailed Starfrontlet": "Golden-tailed Starfrontlet(金尾星额蜂鸟)",
    ...
    "White-bellied Mountaingem": "White-bellied Mountaingem(白腹宝石蜂鸟)",
    "Blue-throated Mountaingem": "Blue-throated Mountaingem(蓝喉宝石蜂鸟)",
    "Amethyst-throated Mountaingem": "Amethyst-throated Mountaingem(辉紫喉宝石蜂鸟)",
    "Green-throated Mountaingem": "Green-throated Mountaingem(绿喉宝石蜂鸟)",
    "Green-breasted Mountaingem": "Green-breasted Mountaingem(绿胸宝石蜂鸟)",
    "Purple-throated Mountaingem": "Purple-throated Mountaingem(紫喉宝石蜂鸟)",
    "Grey-tailed Mountaingem": "Grey-tailed Mountaingem(灰尾宝石蜂鸟)",
    "White-throated Mountaingem": "White-throated Mountaingem(白喉宝石蜂鸟)",
    ...
    "Sparkling-tailed Woodstar": "Sparkling-tailed Woodstar(火尾蜂鸟)",
    "Slender Sheartail": "Slender Sheartail(细剪尾蜂鸟)",
    "Mexican Sheartail": "Mexican Sheartail(墨西哥剪尾蜂鸟)",
    "Lucifer Sheartail": "Lucifer Sheartail(瑰丽蜂鸟)",
    "Beautiful Sheartail": "Beautiful Sheartail(华丽蜂鸟)",
    ...
    "Curve-winged Sabrewing": "Curve-winged Sabrewing(弯翅刀翅蜂鸟)",
    "Wedge-tailed Sabrewing": "Wedge-tailed Sabrewing(楔尾刀翅蜂鸟)",
    ...
    "Grey-breasted Sabrewing": "Grey-breasted Sabrewing(灰胸刀翅蜂鸟)",
    ...
    "Oaxaca Hummingbird": "Oaxaca Hummingbird(蓝顶蜂鸟)",
    ...
    "Cinnamon-sided Hummingbird": "Cinnamon-sided Hummingbird(栗胁蜂鸟)",
    ...
    "Gilded Sapphire": "Gilded Sapphire(金红嘴蜂鸟)",
    ...
    "Blue-throated Sapphire": "Blue-throated Sapphire(蓝喉红嘴蜂鸟)",
    ...
    "Grey Go-away-bird": "Grey Go-away-bird(南非灰蕉鹃)",
    ...
    "Ruspoli's Turaco": "Ruspoli's Turaco(王子蕉鹃)",
    ...
    "Blue Korhaan": "Blue Korhaan(蓝鸨)",
    "Karoo Korhaan": "Karoo Korhaan(黑喉鸨)",
    "Rüppell's Korhaan": "Rüppell's Korhaan(鲁氏鸨)",
    ...
    "Red-crested Korhaan": "Red-crested Korhaan(红冠鸨)",
    "Southern Black Korhaan": "Southern Black Korhaan(黑鸨)",
    "Northern Black Korhaan": "Northern Black Korhaan(白翅黑鸨)",
    ...
    "White-necked Coucal": "White-necked Coucal(杂色鸦鹃)",
    "Ivory-billed Coucal": "Ivory-billed Coucal(大鸦鹃)",
    ...
    "Black-billed Coucal": "Black-billed Coucal(小黑鸦鹃)",
    "Kai Coucal": "Kai Coucal(摩鹿加鸦鹃)",
    ...
    "Rough-crested Malkoha": "Rough-crested Malkoha(蓬冠地鹃)",
    ...
    "Jacobin Cuckoo": "Jacobin Cuckoo(斑翅凤头鹃)",
    ...
    "Grey-capped Cuckoo": "Grey-capped Cuckoo(灰顶美洲鹃)",
    ...
    "Diederik Cuckoo": "Diederik Cuckoo(白眉金鹃)",
    ...
    "Grey-bellied Cuckoo": "Grey-bellied Cuckoo(灰腹杜鹃)",
    ...
    "African Olive Pigeon": "African Olive Pigeon(黄眼鸽)",
    "Cameroon Olive Pigeon": "Cameroon Olive Pigeon(喀麦隆鸽)",
    "Sao Tome Olive Pigeon": "Sao Tome Olive Pigeon(圣多美绿鸽)",
    "Comoro Olive Pigeon": "Comoro Olive Pigeon(科摩罗林鸽)",
    ...
    "Silvery Pigeon": "Silvery Pigeon(银鸽)",
    "Andaman Wood Pigeon": "Andaman Wood Pigeon(安达曼林鸽)",
    "Black Wood Pigeon": "Black Wood Pigeon(黑林鸽)",
    "Bonin Wood Pigeon": "Bonin Wood Pigeon(小笠原杂色林鸽)",
    "Ryukyu Wood Pigeon": "Ryukyu Wood Pigeon(琉球银斑黑鸽)",
    ...
    "Island Bronze-naped Pigeon": "Island Bronze-naped Pigeon(圣多美鸽)",
    ...
    "Maranon Pigeon": "Maranon Pigeon(秘鲁鸽)",
    ...
    "Rodrigues Pigeon": "Rodrigues Pigeon(罗岛蓝鸠)",
    ...
    "Bar-tailed Cuckoo-Dove": "Bar-tailed Cuckoo-Dove(黑嘴鹃鸠)",
    ...
    "Black Cuckoo-Dove": "Black Cuckoo-Dove(黑蕉鸠)",
    ...
    "Common Emerald Dove": "Common Emerald Dove(绿翅金鸠)",
    "Pacific Emerald Dove": "Pacific Emerald Dove(太平洋金鸠)",
    "Stephan's Emerald Dove": "Stephan's Emerald Dove(褐背金鸠)",
    ...
    "Moreno's Ground Dove": "Moreno's Ground Dove(裸眶地鸠)",
    ...
    "Grey-fronted Quail-Dove": "Grey-fronted Quail-Dove(灰头鹑鸠)",
    ...
    "Yungas Dove": "Yungas Dove(大尾棕翅鸠)",
    "Grey-fronted Dove": "Grey-fronted Dove(灰额棕翅鸠)",
    "Grey-headed Dove": "Grey-headed Dove(灰头棕翅鸠)",
    "Pallid Dove": "Pallid Dove(苍棕翅鸠)",
    "Azuero Dove": "Azuero Dove(褐背棕翅鸠)",
    "Grenada Dove": "Grenada Dove(威氏棕翅鸠)",
    "Caribbean Dove": "Caribbean Dove(白腹棕翅鸠)",
    "Grey-chested Dove": "Grey-chested Dove(灰胸棕翅鸠)",
    ...
    "White-breasted Ground Dove": "White-breasted Ground Dove(白胸鸡鸠)",
    "White-fronted Ground Dove": "White-fronted Ground Dove(特岛鸡鸠)",
    ...
    "Grey-fronted Green Pigeon": "Grey-fronted Green Pigeon(灰额绿鸠)",
    ...
    "Grey-cheeked Green Pigeon": "Grey-cheeked Green Pigeon(灰颊绿鸠)",
    ...
    "Ryukyu Green Pigeon": "Ryukyu Green Pigeon(琉球绿鸠)",
    "Taiwan Green Pigeon": "Taiwan Green Pigeon(红顶绿鸠)",
    "Banded Fruit Dove": "Banded Fruit Dove(黑背果鸠)",
    ...
    "Oberholser's Fruit Dove": "Oberholser's Fruit Dove(奥氏果鸠)",
    ...
    "Lilac-crowned Fruit Dove": "Lilac-crowned Fruit Dove(拉罗果鸠)",
    ...
    "Grey-green Fruit Dove": "Grey-green Fruit Dove(灰绿果鸠)",
    ...
    "Henderson Fruit Dove": "Henderson Fruit Dove(亨岛果鸠)",
    ...
    "White-bibbed Fruit Dove": "White-bibbed Fruit Dove(白胸果鸠)",
    ...
    "Grey-headed Fruit Dove": "Grey-headed Fruit Dove(灰头果鸠)",
    ...
    "Grey-headed Imperial Pigeon": "Grey-headed Imperial Pigeon(灰头皇鸠)",
    ...
    "Christmas Imperial Pigeon": "Christmas Imperial Pigeon(圣诞岛皇鸠)",
    "Grey Imperial Pigeon": "Grey Imperial Pigeon(马来皇鸠)",
    ...
    "Vanuatu Imperial Pigeon": "Vanuatu Imperial Pigeon(贝氏皇鸠)",
    "Goliath Imperial Pigeon": "Goliath Imperial Pigeon(巨皇鸠)",
    "Pinon's Imperial Pigeon": "Pinon's Imperial Pigeon(裸眶皇鸠)",
    "Black Imperial Pigeon": "Black Imperial Pigeon(黑皇鸠)",
    ...
    "Grey-throated Rail": "Grey-throated Rail(灰喉秧鸡)",
    ...
    "Grey-cowled Wood Rail": "Grey-cowled Wood Rail(灰颈林秧鸡)",
    ...
    "Brown-banded Rail": "Brown-banded Rail(褐斑秧鸡)",
    "Lewin's Rail": "Lewin's Rail(卢氏秧鸡)",
    "Auckland Rail": "Auckland Rail(奥岛秧鸡)",
    ...
    "Common Moorhen": "Common Moorhen(黑水鸡)",
    "Tristan Moorhen": "Tristan Moorhen(特岛骨顶)",
    "Gough Moorhen": "Gough Moorhen(果夫岛黑水鸡)",
    "Makira Woodhen": "Makira Woodhen(圣岛骨顶)",
    "Samoan Woodhen": "Samoan Woodhen(萨摩亚水鸡)",
    ...
    "Grey-headed Swamphen": "Grey-headed Swamphen(紫水鸡)",
    ...
    "White Swamphen": "White Swamphen(新不列颠紫水鸡)",
    ...
    "Galapagos Crake": "Galapagos Crake(加岛田鸡)",
    "Yellow-breasted Crake": "Yellow-breasted Crake(黄胸田鸡)",
    "Grey-breasted Crake": "Grey-breasted Crake(灰胸田鸡)",
    ...
    "Tahiti Crake": "Tahiti Crake(塔希提田鸡)",
    "Henderson Crake": "Henderson Crake(亨岛田鸡)",
    ...
    "Tricolored Grebe": "Tricolored Grebe(三色小䴙䴘)",
    ...
    "Black-necked Grebe": "Black-necked Grebe(黑颈䴙䴘)",
    ...
    "Common Buttonquail": "Common Buttonquail(林三趾鹑)",
    ...
    "Great Stone-curlew": "Great Stone-curlew(大石鸻)",
    "Beach Stone-curlew": "Beach Stone-curlew(澳洲石鸻)",
    "Spotted Thick-knee": "Spotted Thick-knee(斑石鸻)",
    "Water Thick-knee": "Water Thick-knee(水石鸻)",
    "Bush Stone-curlew": "Bush Stone-curlew(长尾石鸻)",
    "Eurasian Stone-curlew": "Eurasian Stone-curlew(石鸻)",
    "Indian Stone-curlew": "Indian Stone-curlew(印度石鸻)",
    ...
    "Canary Islands Oystercatcher": "Canary Islands Oystercatcher(坎岛蛎鹬)",
    ...
    "White-backed Stilt": "White-backed Stilt(南美长脚鹬)",
    ...
    "African Wattled Lapwing": "African Wattled Lapwing(黑喉麦鸡)",
    "Spot-breasted Lapwing": "Spot-breasted Lapwing(斑胸麦鸡)",
    "Brown-chested Lapwing": "Brown-chested Lapwing(褐胸麦鸡)",
    "Grey-headed Lapwing": "Grey-headed Lapwing(灰头麦鸡)",
    ...
    "Wrybill": "Wrybill(弯嘴鸻)",
    "New Zealand Plover": "New Zealand Plover(新西兰鸻)",
    ...
    "Grey-breasted Seedsnipe": "Grey-breasted Seedsnipe(灰胸籽鹬)",
    ...
    "Grey-tailed Tattler": "Grey-tailed Tattler(灰尾漂鹬)",
    ...
    "Tahiti Sandpiper": "Tahiti Sandpiper(大溪地矶鹬)",
    ...
    "Grey Pratincole": "Grey Pratincole(黄颈灰燕鸻)",
    ...
    "Grey Noddy": "Grey Noddy(灰燕鸥)",
    "Blue Noddy": "Blue Noddy(蓝灰燕鸥)",
    "Aleutian Tern": "Aleutian Tern(白腰燕鸥)",
    "Sooty Tern": "Sooty Tern(乌燕鸥)",
    "Bridled Tern": "Bridled Tern(褐翅燕鸥)",
    "Spectacled Tern": "Spectacled Tern(灰背燕鸥)",
    ...
    "Cabot's Tern": "Cabot's Tern(卡氏凤头燕鸥)",
    ...
    "Greater Crested Tern": "Greater Crested Tern(大凤头燕鸥)",
    ...
    "Grey-headed Gull": "Grey-headed Gull(灰头鸥)",
    "Hartlaub's Gull": "Hartlaub's Gull(哈氏鸥)",
    "Grey Gull": "Grey Gull(灰鸥)",
    ...
    "Black-throated Loon": "Black-throated Loon(黑喉潜鸟)",
    ...
    "Northern Rockhopper Penguin": "Northern Rockhopper Penguin(西凤头黄眉企鹅)",
    ...
    "Grey-backed Storm Petrel": "Grey-backed Storm Petrel(灰背海燕)",
    ...
    "Grey-headed Albatross": "Grey-headed Albatross(灰头信天翁)",
    "Buller's Albatross": "Buller's Albatross(新西兰信天翁)",
    "Shy Albatross": "Shy Albatross(白顶信天翁)",
    ...
    "Campbell Albatross": "Campbell Albatross(坎岛信天翁)",
    ...
    "Grey-faced Petrel": "Grey-faced Petrel(灰脸圆尾鹱)",
    ...
    "Olson's Petrel": "Olson's Petrel(小圣赫勒拿岛海燕)",
    ...
    "Christmas Frigatebird": "Christmas Frigatebird(白腹军舰鸟)",
    ...
    "Rock Shag": "Rock Shag(岩鸬鹚)",
    "Guanay Cormorant": "Guanay Cormorant(南美鸬鹚)",
    "Bounty Shag": "Bounty Shag(邦岛鸬鹚)",
    ...
    "Auckland Shag": "Auckland Shag(奥岛鸬鹚)",
    "Campbell Shag": "Campbell Shag(坎岛鸬鹚)",
    "Imperial Shag": "Imperial Shag(蓝眼鸬鹚)",
    ...
    "Australian White Ibis": "Australian White Ibis(澳洲白鹮)",
    ...
    "American White Ibis": "American White Ibis(美洲白鹮)",
    ...
    "Von Schrenck's Bittern": "Von Schrenck's Bittern(紫背苇鳽)",
    ...
    "Dimorphic Egret": "Dimorphic Egret(礁鹭)",
    ...
    "White-necked Heron": "White-necked Heron(白颈鹭)",
    ...
    "Grey-headed Kite": "Grey-headed Kite(灰头美洲鸢)",
    ...
    "Crested Honey Buzzard": "Crested Honey Buzzard(凤头蜂鹰)",
    "Barred Honey Buzzard": "Barred Honey Buzzard(南洋蜂鹰)",
    "Philippine Honey Buzzard": "Philippine Honey Buzzard(菲律宾蜂鹰)",
    "Swallow-tailed Kite": "Swallow-tailed Kite(燕尾鸢)",
    "Black-breasted Buzzard": "Black-breasted Buzzard(黑胸钩嘴鸢)",
    ...
    "Himalayan Vulture": "Himalayan Vulture(高山兀鹫)",
    ...
    "Cape Vulture": "Cape Vulture(南非兀鹫)",
    "Rüppell's Vulture": "Rüppell's Vulture(黑白兀鹫)",
    "Griffon Vulture": "Griffon Vulture(兀鹫)",
    "Great Nicobar Serpent Eagle": "Great Nicobar Serpent Eagle(尼岛蛇雕)",
    ...
    "Congo Serpent Eagle": "Congo Serpent Eagle(刚果蛇雕)",
    ...
    "Papuan Eagle": "Papuan Eagle(新几内亚角雕)",
    ...
    "Spanish Imperial Eagle": "Spanish Imperial Eagle(西班牙雕)",
    "Eastern Imperial Eagle": "Eastern Imperial Eagle(白肩雕)",
    ...
    "Besra": "Besra(松雀鹰)",
    "Dwarf Sparrowhawk": "Dwarf Sparrowhawk(苏拉威西雀鹰)",
    ...
    "Spot-tailed Sparrowhawk": "Spot-tailed Sparrowhawk(斑尾鹰)",
    "Grey-headed Goshawk": "Grey-headed Goshawk(苍头鹰)",
    "New Britain Goshawk": "New Britain Goshawk(灰头鹰)",
    "Grey Goshawk": "Grey Goshawk(灰鹰)",
    "Variable Goshawk": "Variable Goshawk(杂色鹰)",
    "Imitator Goshawk": "Imitator Goshawk(拟雀鹰)",
    ...
    "White-breasted Hawk": "White-breasted Hawk(白胸鹰)",
    "Plain-breasted Hawk": "Plain-breasted Hawk(淡胸鹰)",
    "Rufous-thighed Hawk": "Rufous-thighed Hawk(红腿鹰)",
    ...
    "Black Sparrowhawk": "Black Sparrowhawk(黑鹰)",
    ...
    "Yellow-billed Kite": "Yellow-billed Kite(黄嘴鸢)",
    ...
    "Grey-headed Fish Eagle": "Grey-headed Fish Eagle(灰头渔雕)",
    ...
    "Grey-faced Buzzard": "Grey-faced Buzzard(灰脸鵟鹰)",
    ...
    "Grey-backed Hawk": "Grey-backed Hawk(灰背南美鵟)",
    ...
    "Grey Hawk": "Grey Hawk(灰鵟)",
    "Grey-lined Hawk": "Grey-lined Hawk(灰纹鵟)",
    ...
    "Rough-legged Buzzard": "Rough-legged Buzzard(毛脚鵟)",
    ...
    "Cape Verde Buzzard": "Cape Verde Buzzard(佛得角鵟)",
    ...
    "Greater Sooty Owl": "Greater Sooty Owl(乌草鸮)",
    "Lesser Sooty Owl": "Lesser Sooty Owl(小乌草鸮)",
    "Minahasa Masked Owl": "Minahasa Masked Owl(米纳仓鸮)",
    "Taliabu Masked Owl": "Taliabu Masked Owl(塔里仓鸮)",
    "Moluccan Masked Owl": "Moluccan Masked Owl(小草鸮)",
    ...
    "Christmas Boobook": "Christmas Boobook(圣诞岛鹰鸮)",
    ...
    "New Ireland Boobook": "New Ireland Boobook(俾斯麦鹰鸮)",
    ...
    "Sjöstedt's Barred Owlet": "Sjöstedt's Barred Owlet(中非鸺鹠)",
    ...
    "Northern Pygmy Owl": "Northern Pygmy Owl(北美鸺鹠)",
    "Mountain Pygmy Owl": "Mountain Pygmy Owl(山鸺鹠)",
    "Baja Pygmy Owl": "Baja Pygmy Owl(海角鸺鹠)",
    "Guatemalan Pygmy Owl": "Guatemalan Pygmy Owl(危地马拉鸺鹠)",
    ...
    "East Brazilian Pygmy Owl": "East Brazilian Pygmy Owl(巴西鸺鹠)",
    "Pernambuco Pygmy Owl": "Pernambuco Pygmy Owl(伯州鸺鹠)",
    "Ferruginous Pygmy Owl": "Ferruginous Pygmy Owl(棕鸺鹠)",
    "Pacific Pygmy Owl": "Pacific Pygmy Owl(秘鲁鸺鹠)",
    ...
    "Torotoroka Scops Owl": "Torotoroka Scops Owl(托罗卡角鸮)",
    "Rainforest Scops Owl": "Rainforest Scops Owl(马岛角鸮)",
    "Mayotte Scops Owl": "Mayotte Scops Owl(马约特岛角鸮)",
    "Karthala Scops Owl": "Karthala Scops Owl(科摩罗角鸮)",
    ...
    "Annobon Scops Owl": "Annobon Scops Owl(安诺本角鸮)",
    ...
    "Yungas Screech Owl": "Yungas Screech Owl(霍氏角鸮)",
    ...
    "West Peruvian Screech Owl": "West Peruvian Screech Owl(秘鲁角鸮)",
    ...
    "Great Grey Owl": "Great Grey Owl(乌林鸮)",
    ...
    "Choco Trogon": "Choco Trogon(白眼美洲咬鹃)",
    ...
    "Forest Wood Hoopoe": "Forest Wood Hoopoe(栗头林戴胜)",
    "White-headed Wood Hoopoe": "White-headed Wood Hoopoe(白头林戴胜)",
    "Green Wood Hoopoe": "Green Wood Hoopoe(绿林戴胜)",
    "Black-billed Wood Hoopoe": "Black-billed Wood Hoopoe(黑嘴林戴胜)",
    "Violet Wood Hoopoe": "Violet Wood Hoopoe(紫林戴胜)",
    ...
    "African Grey Hornbill": "African Grey Hornbill(黑嘴弯嘴犀鸟)",
    ...
    "Malabar Grey Hornbill": "Malabar Grey Hornbill(印度灰犀鸟)",
    "Sri Lanka Grey Hornbill": "Sri Lanka Grey Hornbill(斯里兰卡灰犀鸟)",
    "Indian Grey Hornbill": "Indian Grey Hornbill(灰犀鸟)",
    "Tickell's Brown Hornbill": "Tickell's Brown Hornbill(锈颊犀鸟)",
    "Austen's Brown Hornbill": "Austen's Brown Hornbill(白喉犀鸟)",
    ...
    "Walden's Hornbill": "Walden's Hornbill(红头犀鸟)",
    ...
    "Oriental Dollarbird": "Oriental Dollarbird(三宝鸟)",
    "Azure Dollarbird": "Azure Dollarbird(翠蓝三宝鸟)",
    ...
    "Spotted Wood Kingfisher": "Spotted Wood Kingfisher(斑林翡翠)",
    ...
    "Grey-headed Kingfisher": "Grey-headed Kingfisher(灰头翡翠)",
    ...
    "White-mantled Kingfisher": "White-mantled Kingfisher(白背翡翠)",
    ...
    "Islet Kingfisher": "Islet Kingfisher(小岛翡翠)",
    ...
    "Rusty-capped Kingfisher": "Rusty-capped Kingfisher(锈顶翡翠)",
    ...
    "Mangareva Kingfisher": "Mangareva Kingfisher(土岛翡翠)",
    "Niau Kingfisher": "Niau Kingfisher(尼澳岛翡翠)",
    ...
    "Cerulean Kingfisher": "Cerulean Kingfisher(小蓝翠鸟)",
    ...
    "Blue-necked Jacamar": "Blue-necked Jacamar(蓝颈鹟䴕)",
    ...
    "Grey-cheeked Nunlet": "Grey-cheeked Nunlet(灰颊小蓬头䴕)",
    ...
    "Citron-throated Toucan": "Citron-throated Toucan(淡黄喉巨嘴鸟)",
    ...
    "Stripe-billed Aracari": "Stripe-billed Aracari(斑嘴簇舌巨嘴鸟)",
    ...
    "Grey-breasted Mountain Toucan": "Grey-breasted Mountain Toucan(灰胸山巨嘴鸟)",
    ...
    "Wagler's Toucanet": "Wagler's Toucanet(韦氏绿巨嘴鸟)",
    "Emerald Toucanet": "Emerald Toucanet(绿巨嘴鸟)",
    "Blue-throated Toucanet": "Blue-throated Toucanet(蓝喉巨嘴鸟)",
    "White-throated Toucanet": "White-throated Toucanet(白喉巨嘴鸟)",
    "Black-throated Toucanet": "Black-throated Toucanet(黑喉巨嘴鸟)",
    ...
    "Golden-whiskered Barbet": "Golden-whiskered Barbet(金须拟啄木鸟)",
    ...
    "Usambiro Barbet": "Usambiro Barbet(坦桑拟啄木鸟)",
    "Green Barbet": "Green Barbet(非洲绿拟啄木鸟)",
    "Grey-throated Barbet": "Grey-throated Barbet(灰喉拟啄木鸟)",
    ...
    "Miombo Pied Barbet": "Miombo Pied Barbet(疏林拟啄木鸟)",
    "Acacia Pied Barbet": "Acacia Pied Barbet(斑拟啄木鸟)",
    ...
    "Greyish Piculet": "Greyish Piculet(灰姬啄木鸟)",
    ...
    "Grey-and-buff Woodpecker": "Grey-and-buff Woodpecker(灰黄啄木鸟)",
    ...
    "Grey-breasted Woodpecker": "Grey-breasted Woodpecker(灰胸啄木鸟)",
    ...
    "Little Green Woodpecker": "Little Green Woodpecker(小绿啄木鸟)",
    "Little Spotted Woodpecker": "Little Spotted Woodpecker(绿背啄木鸟)",
    ...
    "Grey-capped Pygmy Woodpecker": "Grey-capped Pygmy Woodpecker(星头啄木鸟)",
    ...
    "Yellow-crested Woodpecker": "Yellow-crested Woodpecker(金冠啄木鸟)",
    "Fire-bellied Woodpecker": "Fire-bellied Woodpecker(火腹啄木鸟)",
    "Little Grey Woodpecker": "Little Grey Woodpecker(小灰啄木鸟)",
    ...
    "African Grey Woodpecker": "African Grey Woodpecker(灰啄木鸟)",
    "Eastern Grey Woodpecker": "Eastern Grey Woodpecker(灰头啄木鸟)",
    ...
    "Yellow-browed Woodpecker": "Yellow-browed Woodpecker(白眉啄木鸟)",
    "Golden-olive Woodpecker": "Golden-olive Woodpecker(高原啄木鸟)",
    "Bronze-winged Woodpecker": "Bronze-winged Woodpecker(铜翅啄木鸟)",
    "Grey-crowned Woodpecker": "Grey-crowned Woodpecker(灰顶啄木鸟)",
    ...
    "Variable Woodpecker": "Variable Woodpecker(波斑啄木鸟)",
    ...
    "Splendid Woodpecker": "Splendid Woodpecker(丽色啄木鸟)",
    ...
    "Japanese Green Woodpecker": "Japanese Green Woodpecker(日本绿啄木鸟)",
    "European Green Woodpecker": "European Green Woodpecker(绿啄木鸟)",
    ...
    "Grey-headed Woodpecker": "Grey-headed Woodpecker(灰头绿啄木鸟)",
    "Sumatran Woodpecker": "Sumatran Woodpecker(苏门答腊绿啄木鸟)",
    ...
    "Common Kestrel": "Common Kestrel(红隼)",
    ...
    "Norfolk Kaka": "Norfolk Kaka(诺福克啄羊鹦鹉)",
    ...
    "Red-vented Cockatoo": "Red-vented Cockatoo(菲律宾凤头鹦鹉)",
    ...
    "Grey-hooded Parakeet": "Grey-hooded Parakeet(灰顶鹦哥)",
    ...
    "Manu Parrotlet": "Manu Parrotlet(亚马孙鹦哥)",
    ...
    "Grey-cheeked Parakeet": "Grey-cheeked Parakeet(灰颊鹦哥)",
    ...
    "Fuertes's Parrot": "Fuertes's Parrot(红肩鹦哥)",
    ...
    "Plum-crowned Parrot": "Plum-crowned Parrot(紫冠鹦哥)",
    "White-capped Parrot": "White-capped Parrot(白顶鹦哥)",
    ...
    "Yucatan Amazon": "Yucatan Amazon(黄眼先鹦哥)",
    ...
    "Grey-breasted Parakeet": "Grey-breasted Parakeet(栗腹鹦哥)",
    "White-eared Parakeet": "White-eared Parakeet(白耳鹦哥)",
    ...
    "White-breasted Parakeet": "White-breasted Parakeet(白颈鹦哥)",
    "Black-capped Parakeet": "Black-capped Parakeet(黑顶鹦哥)",
    "Flame-winged Parakeet": "Flame-winged Parakeet(褐胸鹦哥)",
    "Blood-eared Parakeet": "Blood-eared Parakeet(红耳鹦哥)",
    "Rose-crowned Parakeet": "Rose-crowned Parakeet(赤头鹦哥)",
    ...
    "Burrowing Parrot": "Burrowing Parrot(穴鹦哥)",
    "Hyacinth Macaw": "Hyacinth Macaw(紫蓝金刚鹦鹉)",
    "Lear's Macaw": "Lear's Macaw(青蓝金刚鹦鹉)",
    ...
    "Caatinga Parakeet": "Caatinga Parakeet(仙人掌鹦哥)",
    ...
    "Golden-collared Macaw": "Golden-collared Macaw(金领金刚鹦鹉)",
    ...
    "Finsch's Parakeet": "Finsch's Parakeet(绯额鹦哥)",
    ...
    "Seychelles Black Parrot": "Seychelles Black Parrot(塞舌尔黑鹦鹉)",
    ...
    "Jonquil Parrot": "Jonquil Parrot(帝汶红翅鹦鹉)",
    "Red-winged Parrot": "Red-winged Parrot(红翅鹦鹉)",
    "Buru Racket-tail": "Buru Racket-tail(布岛扇尾鹦鹉)",
    "Golden-mantled Racket-tail": "Golden-mantled Racket-tail(金肩扇尾鹦鹉)",
    "Mindanao Racket-tail": "Mindanao Racket-tail(棉岛扇尾鹦鹉)",
    "Montane Racket-tail": "Montane Racket-tail(山扇尾鹦鹉)",
    "Blue-headed Racket-tail": "Blue-headed Racket-tail(巴拉望扇尾鹦鹉)",
    "Mindoro Racket-tail": "Mindoro Racket-tail(民岛扇尾鹦鹉)",
    "Blue-winged Racket-tail": "Blue-winged Racket-tail(苏禄扇尾鹦鹉)",
    "Yellow-breasted Racket-tail": "Yellow-breasted Racket-tail(红斑扇尾鹦鹉)",
    "Green Racket-tail": "Green Racket-tail(绿扇尾鹦鹉)",
    "Blue-crowned Racket-tail": "Blue-crowned Racket-tail(蓝冠扇尾鹦鹉)",
    ...
    "Grey-headed Parakeet": "Grey-headed Parakeet(灰头鹦鹉)",
    ...
    "Lord Derby's Parakeet": "Lord Derby's Parakeet(大紫胸鹦鹉)",
    "Long-tailed Parakeet": "Long-tailed Parakeet(长尾鹦鹉)",
    "Blue-winged Parakeet": "Blue-winged Parakeet(马拉巴鹦鹉)",
    ...
    "Mascarene Grey Parakeet": "Mascarene Grey Parakeet(毛里求斯灰鹦鹉)",
    ...
    "Eastern Bluebonnet": "Eastern Bluebonnet(红腹蓝额鹦鹉)",
    ...
    "Maroon Shining Parrot": "Maroon Shining Parrot(红胸辉鹦鹉)",
    ...
    "Norfolk Parakeet": "Norfolk Parakeet(诺福克红额鹦鹉)",
    "Lord Howe Parakeet": "Lord Howe Parakeet(豪勋爵岛鹦鹉)",
    ...
    "Great Hanging Parrot": "Great Hanging Parrot(苏拉威西短尾鹦鹉)",
    ...
    "Orange-fronted Hanging Parrot": "Orange-fronted Hanging Parrot(橙额短尾鹦鹉)",
    "Bismarck Hanging Parrot": "Bismarck Hanging Parrot(绿额短尾鹦鹉)",
    ...
    "Grey-headed Lovebird": "Grey-headed Lovebird(灰头牡丹鹦鹉)",
    ...
    "Bushwren": "Bushwren(丛异鹩)",
    "New Zealand Rockwren": "New Zealand Rockwren(新西兰岩鹩)",
    "Lyall's Wren": "Lyall's Wren(斯蒂芬岛异鹩)",
    ...
    "Grey-lored Broadbill": "Grey-lored Broadbill(灰眼先丝冠鸟)",
    ...
    "Grey-headed Broadbill": "Grey-headed Broadbill(灰头阔嘴鸟)",
    ...
    "Tawny-throated Leaftosser": "Tawny-throated Leaftosser(茶喉硬尾雀)",
    "Dusky Leaftosser": "Dusky Leaftosser(暗色硬尾雀)",
    ...
    "Grey-throated Leaftosser": "Grey-throated Leaftosser(灰喉硬尾雀)",
    ...
    "Greyish Miner": "Greyish Miner(灰掘穴雀)",
    ...
    "Little Long-tailed Woodcreeper": "Little Long-tailed Woodcreeper(小长尾䴕雀)",
    "Northern Long-tailed Woodcreeper": "Northern Long-tailed Woodcreeper(长尾䴕雀)",
    "Southern Long-tailed Woodcreeper": "Southern Long-tailed Woodcreeper(南长尾䴕雀)",
    ...
    "Band-tailed Hornero": "Band-tailed Hornero(白斑灶鸟)",
    ...
    "Grey-flanked Cinclodes": "Grey-flanked Cinclodes(灰胁抖尾地雀)",
    ...
    "Peruvian Seaside Cinclodes": "Peruvian Seaside Cinclodes(逐浪抖尾地雀)",
    "Chilean Seaside Cinclodes": "Chilean Seaside Cinclodes(海滨抖尾地雀)",
    "Bamboo Foliage-gleaner": "Bamboo Foliage-gleaner(冠拾叶雀)",
    ...
    "Planalto Foliage-gleaner": "Planalto Foliage-gleaner(草黄拾叶雀)",
    "Tepui Foliage-gleaner": "Tepui Foliage-gleaner(白喉拾叶雀)",
    ...
    "Henna-capped Foliage-gleaner": "Henna-capped Foliage-gleaner(栗顶拾叶雀)",
    ...
    "Peruvian Treehunter": "Peruvian Treehunter(黄喉树猎雀)",
    ...
    "Star-chested Treerunner": "Star-chested Treerunner(黄斑爬树雀)",
    ...
    "Streak-backed Tit-Spinetail": "Streak-backed Tit-Spinetail(纹针尾雀)",
    ...
    "Double-banded Greytail": "Double-banded Greytail(双斑灰尾雀)",
    "Equatorial Greytail": "Equatorial Greytail(赤道灰尾雀)",
    ...
    "Grey-headed Spinetail": "Grey-headed Spinetail(灰头针尾雀)",
    ...
    "Grey-crested Cacholote": "Grey-crested Cacholote(灰冠巨灶鸫)",
    ...
    "Grey-bellied Spinetail": "Grey-bellied Spinetail(灰腹针尾雀)",
    ...
    "Maranon Spinetail": "Maranon Spinetail(马谷针尾雀)",
    ...
    "Grey-bellied Antbird": "Grey-bellied Antbird(灰腹蚁鸟)",
    ...
    "Silvery-flanked Antwren": "Silvery-flanked Antwren(银胁蚁鹩)",
    ...
    "Yungas Antwren": "Yungas Antwren(淡灰蚁鹩)",
    ...
    "Blackish-grey Antshrike": "Blackish-grey Antshrike(黑灰蚁鵙)",
    ...
    "Speckled Antshrike": "Speckled Antshrike(点胸蚁鵙)",
    ...
    "Southern Chestnut-tailed Antbird": "Southern Chestnut-tailed Antbird(南栗尾蚁鸟)",
    "Northern Chestnut-tailed Antbird": "Northern Chestnut-tailed Antbird(北栗尾蚁鸟)",
    ...
    "Grey-headed Antbird": "Grey-headed Antbird(灰头蚁鸟)",
    ...
    "Cryptic Antthrush": "Cryptic Antthrush(萨氏蚁鸫)",
    ...
    "Grey-naped Antpitta": "Grey-naped Antpitta(灰颈蚁鸫)",
    ...
    "Rufous-breasted Antpitta": "Rufous-breasted Antpitta(红褐胸蚁鸫)",
    "Slaty-crowned Antpitta": "Slaty-crowned Antpitta(蓝顶蚁鸫)",
    ...
    "Narino Tapaculo": "Narino Tapaculo(太平洋窜鸟)",
    ...
    "El Oro Tapaculo": "El Oro Tapaculo(厄瓜多尔窜鸟)",
    ...
    "Maranon Crescentchest": "Maranon Crescentchest(秘鲁月胸窜鸟)",
    "Elegant Crescentchest": "Elegant Crescentchest(丽月胸窜鸟)",
    "Grey-headed Piprites": "Grey-headed Piprites(灰头娇鹟)",
    ...
    "Grey-capped Tyrannulet": "Grey-capped Tyrannulet(灰顶小霸鹟)",
    ...
    "Grey-headed Elaenia": "Grey-headed Elaenia(灰色伊拉鹟)",
    ...
    "Chilean Elaenia": "Chilean Elaenia(智利拟霸鹟)",
    ...
    "Maranon Tyrannulet": "Maranon Tyrannulet(马谷白腹灰色小霸鹟)",
    "Yellow Tyrannulet": "Yellow Tyrannulet(黄小霸鹟)",
    "Bearded Tachuri": "Bearded Tachuri(须多斑霸鹟)",
    "Grey-backed Tachuri": "Grey-backed Tachuri(灰背多斑霸鹟)",
    ...
    "Grey-and-white Tyrannulet": "Grey-and-white Tyrannulet(灰白小霸鹟)",
    ...
    "Coopmans's Tyrannulet": "Coopmans's Tyrannulet(库氏小霸鹟)",
    "Choco Tyrannulet": "Choco Tyrannulet(灰喉金脸小霸鹟)",
    "Loja Tyrannulet": "Loja Tyrannulet(厄瓜多尔小霸鹟)",
    ...
    "Panama Tyrannulet": "Panama Tyrannulet(黄绿姬霸鹟)",
    ...
    "Grey-hooded Flycatcher": "Grey-hooded Flycatcher(灰冠霸鹟)",
    ...
    "Slender-billed Inezia": "Slender-billed Inezia(细嘴姬霸鹟)",
    "Plain Inezia": "Plain Inezia(纯色姬霸鹟)",
    "Amazonian Inezia": "Amazonian Inezia(亚马孙姬霸鹟)",
    "Pale-tipped Inezia": "Pale-tipped Inezia(白眼姬霸鹟)",
    ...
    "Mouse-grey Flycatcher": "Mouse-grey Flycatcher(灰褐斑翅霸鹟)",
    ...
    "Sharp-tailed Grass Tyrant": "Sharp-tailed Grass Tyrant(尖尾霸鹟)",
    "Drab-breasted Bamboo Tyrant": "Drab-breasted Bamboo Tyrant(淡褐胸侏霸鹟)",
    "Brown-breasted Bamboo Tyrant": "Brown-breasted Bamboo Tyrant(褐胸侏霸鹟)",
    "Flammulated Bamboo Tyrant": "Flammulated Bamboo Tyrant(红侏霸鹟)",
    ...
    "Fork-tailed Tody-Tyrant": "Fork-tailed Tody-Tyrant(叉尾哑霸鹟)",
    ...
    "Lulu's Tody-Flycatcher": "Lulu's Tody-Flycatcher(红头哑霸鹟)",
    ...
    "Slaty-headed Tody-Flycatcher": "Slaty-headed Tody-Flycatcher(蓝灰头哑霸鹟)",
    ...
    "Yellow-lored Tody-Flycatcher": "Yellow-lored Tody-Flycatcher(灰头哑霸鹟)",
    ...
    "Grey-crowned Flatbill": "Grey-crowned Flatbill(灰顶霸鹟)",
    ...
    "Cinnamon Neopipo": "Cinnamon Neopipo(栗红霸鹟)",
    ...
    "Grey-breasted Flycatcher": "Grey-breasted Flycatcher(灰胸纹霸鹟)",
    ...
    "Northern Tufted Flycatcher": "Northern Tufted Flycatcher(领霸鹟)",
    "Olive Tufted Flycatcher": "Olive Tufted Flycatcher(橄榄色霸鹟)",
    ...
    "American Dusky Flycatcher": "American Dusky Flycatcher(暗纹霸鹟)",
    "American Grey Flycatcher": "American Grey Flycatcher(灰纹霸鹟)",
    ...
    "Scarlet Flycatcher": "Scarlet Flycatcher(猩红霸鹟)",
    "Vermilion Flycatcher": "Vermilion Flycatcher(朱红霸鹟)",
    "Darwin's Flycatcher": "Darwin's Flycatcher(小朱红霸鹟)",
    "San Cristobal Flycatcher": "San Cristobal Flycatcher(圣岛霸鹟)",
    ...
    "Paramo Ground Tyrant": "Paramo Ground Tyrant(淡顶地霸鹟)",
    ...
    "Plumbeous Tyrant": "Plumbeous Tyrant(淡嘴黑霸鹟)",
    ...
    "Sao Francisco Black Tyrant": "Sao Francisco Black Tyrant(巴西黑霸鹟)",
    ...
    "Grey Monjita": "Grey Monjita(灰蒙霸鹟)",
    ...
    "Grey-bellied Shrike-Tyrant": "Grey-bellied Shrike-Tyrant(灰腹鵙霸鹟)",
    "Great Shrike-Tyrant": "Great Shrike-Tyrant(大鵙霸鹟)",
    "Streamer-tailed Tyrant": "Streamer-tailed Tyrant(飘带尾霸鹟)",
    "Shear-tailed Grey Tyrant": "Shear-tailed Grey Tyrant(剪尾灰霸鹟)",
    ...
    "Tumbes Tyrant": "Tumbes Tyrant(通贝斯唧霸鹟)",
    "Crowned Chat-Tyrant": "Crowned Chat-Tyrant(冠唧霸鹟)",
    "Kalinowski's Chat-Tyrant": "Kalinowski's Chat-Tyrant(秘鲁唧霸鹟)",
    ...
    "Slaty-backed Chat-Tyrant": "Slaty-backed Chat-Tyrant(灰背唧霸鹟)",
    ...
    "Grey-capped Flycatcher": "Grey-capped Flycatcher(灰顶短嘴霸鹟)",
    ...
    "White-eyed Attila": "White-eyed Attila(暗顶阿蒂霸鹟)",
    "Grey-hooded Attila": "Grey-hooded Attila(灰头阿蒂霸鹟)",
    ...
    "Grey-tailed Piha": "Grey-tailed Piha(灰尾伞鸟)",
    ...
    "Palkachupa Cotinga": "Palkachupa Cotinga(黄眼燕尾伞鸟)",
    ...
    "Grey-winged Cotinga": "Grey-winged Cotinga(灰翅伞鸟)",
    ...
    "Blue Manakin": "Blue Manakin(燕尾娇鹟)",
    ...
    "Orange-crested Manakin": "Orange-crested Manakin(橙顶娇鹟)",
    "Yellow-crested Manakin": "Yellow-crested Manakin(黄顶娇鹟)",
    "Flame-crested Manakin": "Flame-crested Manakin(赤顶娇鹟)",
    ...
    "Guianan Schiffornis": "Guianan Schiffornis(圭亚那希夫霸鹟)",
    ...
    "Yellow-cheeked Becard": "Yellow-cheeked Becard(黄颊厚嘴霸鹟)",
    ...
    "Grey-collared Becard": "Grey-collared Becard(灰领厚嘴霸鹟)",
    ...
    "Tawny-breasted Myiobius": "Tawny-breasted Myiobius(茶胸黄腰霸鹟)",
    "Sulphur-rumped Myiobius": "Sulphur-rumped Myiobius(硫磺腰霸鹟)",
    "Whiskered Myiobius": "Whiskered Myiobius(须黄腰霸鹟)",
    "Black-tailed Myiobius": "Black-tailed Myiobius(黑尾黄腰霸鹟)",
    ...
    "Rufous Scrubbird": "Rufous Scrubbird(棕薮鸟)",
    "Noisy Scrubbird": "Noisy Scrubbird(噪薮鸟)",
    ...
    "Huon Bowerbird": "Huon Bowerbird(休恩亭鸟)",
    ...
    "Southern Emu-wren": "Southern Emu-wren(帚尾鹩莺)",
    "Mallee Emu-wren": "Mallee Emu-wren(马里帚尾鹩莺)",
    "Rufous-crowned Emu-wren": "Rufous-crowned Emu-wren(棕帚尾鹩莺)",
    "Grey Grasswren": "Grey Grasswren(灰草鹩莺)",
    ...
    "Yellowish-streaked Honeyeater": "Yellowish-streaked Honeyeater(绿纹嗜蜜鸟)",
    ...
    "Grey-streaked Honeyeater": "Grey-streaked Honeyeater(黑背嗜蜜鸟)",
    ...
    "Grey Honeyeater": "Grey Honeyeater(灰蚊蜜鸟)",
    ...
    "Common Smoky Honeyeater": "Common Smoky Honeyeater(烟色饮蜜鸟)",
    "Wattled Smoky Honeyeater": "Wattled Smoky Honeyeater(红脸饮蜜鸟)",
    ...
    "White-bellied Honeyeater": "White-bellied Honeyeater(白腹澳蜜鸟)",
    ...
    "Scaly-crowned Honeyeater": "Scaly-crowned Honeyeater(鳞顶岩吸蜜鸟)",
    "Black Honeyeater": "Black Honeyeater(黑吸蜜鸟)",
    "White-streaked Friarbird": "White-streaked Friarbird(摩鹿加吮蜜鸟)",
    "Gilliard's Honeyeater": "Gilliard's Honeyeater(山寻蜜鸟)",
    "Drab Myzomela": "Drab Myzomela(布氏摄蜜鸟)",
    ...
    "Wetar Myzomela": "Wetar Myzomela(红巾摄蜜鸟)",
    ...
    "Mountain Myzomela": "Mountain Myzomela(山摄蜜鸟)",
    ...
    "Red-capped Myzomela": "Red-capped Myzomela(红枕摄蜜鸟)",
    "Crimson-rumped Myzomela": "Crimson-rumped Myzomela(黄臀摄蜜鸟)",
    "Red-vested Myzomela": "Red-vested Myzomela(红腹摄蜜鸟)",
    ...
    "Grey Friarbird": "Grey Friarbird(灰吮蜜鸟)",
    ...
    "Manus Friarbird": "Manus Friarbird(白枕吮蜜鸟)",
    ...
    "Grey-eared Honeyeater": "Grey-eared Honeyeater(银耳岩吸蜜鸟)",
    "Silver-eared Honeyeater": "Silver-eared Honeyeater(白耳岩吸蜜鸟)",
    "Scaly-breasted Honeyeater": "Scaly-breasted Honeyeater(白簇岩吸蜜鸟)",
    "Buru Honeyeater": "Buru Honeyeater(布鲁岩吸蜜鸟)",
    "Seram Honeyeater": "Seram Honeyeater(塞兰岩吸蜜鸟)",
    "Flame-eared Honeyeater": "Flame-eared Honeyeater(黄耳岩吸蜜鸟)",
    "Black-necklaced Honeyeater": "Black-necklaced Honeyeater(黑胸岩吸蜜鸟)",
    ...
    "Polynesian Wattled Honeyeater": "Polynesian Wattled Honeyeater(肉垂吸蜜鸟)",
    "Fiji Wattled Honeyeater": "Fiji Wattled Honeyeater(北肉垂吸蜜鸟)",
    "Kikau": "Kikau(西肉垂吸蜜鸟)",
    ...
    "Mottle-breasted Honeyeater": "Mottle-breasted Honeyeater(斑胸吸蜜鸟)",
    ...
    "Grey-headed Honeyeater": "Grey-headed Honeyeater(灰头吸蜜鸟)",
    "Grey-fronted Honeyeater": "Grey-fronted Honeyeater(澳洲灰额吸蜜鸟)",
    ...
    "Bicolored Scrubwren": "Bicolored Scrubwren(中山鼠莺)",
    "Vogelkop Scrubwren": "Vogelkop Scrubwren(瓦格丝刺莺)",
    "Buff-faced Scrubwren": "Buff-faced Scrubwren(棕脸丝刺莺)",
    "Grey-green Scrubwren": "Grey-green Scrubwren(灰绿丝刺莺)",
    ...
    "Grey Thornbill": "Grey Thornbill(新几内亚刺嘴莺)",
    "New Guinea Thornbill": "New Guinea Thornbill(巴布亚刺嘴莺)",
    ...
    "Norfolk Gerygone": "Norfolk Gerygone(诺岛噪刺莺)",
    "Grey Gerygone": "Grey Gerygone(灰噪刺莺)",
    "Chatham Islands Gerygone": "Chatham Islands Gerygone(查岛噪刺莺)",
    "Papuan Babbler": "Papuan Babbler(弯嘴鹛)",
    "Grey-crowned Babbler": "Grey-crowned Babbler(灰冠弯嘴鹛)",
    ...
    "Slaty-headed Longbill": "Slaty-headed Longbill(灰颏弯嘴吸蜜鸟)",
    ...
    "Brown-headed Jewel-babbler": "Brown-headed Jewel-babbler(棕头丽鸫)",
    ...
    "Margaret's Batis": "Margaret's Batis(布氏蓬背鹟)",
    "Forest Batis": "Forest Batis(短尾蓬背鹟)",
    ...
    "Grey-headed Batis": "Grey-headed Batis(灰头蓬背鹟)",
    ...
    "Grey-headed Bushshrike": "Grey-headed Bushshrike(灰头丛鵙)",
    ...
    "Bocage's Bushshrike": "Bocage's Bushshrike(灰绿丛鵙)",
    "Orange-breasted Bushshrike": "Orange-breasted Bushshrike(橙胸丛鵙)",
    "Gorgeous Bushshrike": "Gorgeous Bushshrike(四色丛鵙)",
    ...
    "Mountain Sooty Boubou": "Mountain Sooty Boubou(山地黑鵙)",
    "Albertine Sooty Boubou": "Albertine Sooty Boubou(艾伯丁黑鵙)",
    ...
    "Crimson-breasted Shrike": "Crimson-breasted Shrike(红胸黑鵙)",
    ...
    "Grey-crested Helmetshrike": "Grey-crested Helmetshrike(灰冠盔鵙)",
    ...
    "Gabela Helmetshrike": "Gabela Helmetshrike(安哥拉盔鵙)",
    ...
    "White-backed Woodswallow": "White-backed Woodswallow(俾斯麦燕鵙)",
    ...
    "Grey Butcherbird": "Grey Butcherbird(灰钟鹊)",
    ...
    "Grey-chinned Minivet": "Grey-chinned Minivet(灰喉山椒鸟)",
    "Sunda Minivet": "Sunda Minivet(巽他山椒鸟)",
    "Short-billed Minivet": "Short-billed Minivet(短嘴山椒鸟)",
    "Little Minivet": "Little Minivet(三色山椒鸟)",
    ...
    "Swinhoe's Minivet": "Swinhoe's Minivet(小灰山椒鸟)",
    ...
    "Grey Cuckooshrike": "Grey Cuckooshrike(非洲灰鹃鵙)",
    ...
    "Western Wattled Cuckooshrike": "Western Wattled Cuckooshrike(加纳鹃鵙)",
    "Eastern Wattled Cuckooshrike": "Eastern Wattled Cuckooshrike(鹂鹃鵙)",
    ...
    "Black-bellied Cuckooshrike": "Black-bellied Cuckooshrike(高山鹃鵙)",
    ...
    "Grey-headed Cuckooshrike": "Grey-headed Cuckooshrike(灰头鹃鵙)",
    ...
    "Admiralty Cicadabird": "Admiralty Cicadabird(阿岛鹃鵙)",
    ...
    "Black-shouldered Cicadabird": "Black-shouldered Cicadabird(黑肩鹃鵙)",
    ...
    "Northern Shriketit": "Northern Shriketit(北鵙雀鹟)",
    "Western Shriketit": "Western Shriketit(西鵙雀鹟)",
    "Eastern Shriketit": "Eastern Shriketit(东鵙雀鹟)",
    ...
    "Sulphur-vented Whistler": "Sulphur-vented Whistler(硫黄腹啸鹟)",
    "Bornean Whistler": "Bornean Whistler(加里啸鹟)",
    "Vogelkop Whistler": "Vogelkop Whistler(弗格克啸鹟)",
    "Grey Whistler": "Grey Whistler(灰啸鹟)",
    ...
    "Yellow-throated Whistler": "Yellow-throated Whistler(黄喉啸鹟)",
    "Baliem Whistler": "Baliem Whistler(巴列姆啸鹟)",
    "Black-chinned Whistler": "Black-chinned Whistler(黑颏啸鹟)",
    "Australian Golden Whistler": "Australian Golden Whistler(金啸鹟)",
    "Western Whistler": "Western Whistler(西方啸鹟)",
    ...
    "Melanesian Whistler": "Melanesian Whistler(美岛啸鹟)",
    ...
    "Mangrove Golden Whistler": "Mangrove Golden Whistler(黑尾啸鹟)",
    "Samoan Whistler": "Samoan Whistler(黄额啸鹟)",
    "Hooded Whistler": "Hooded Whistler(山啸鹟)",
    "Bougainville Whistler": "Bougainville Whistler(黑喉山啸鹟)",
    ...
    "Cinnamon-breasted Whistler": "Cinnamon-breasted Whistler(红胸啸鹟)",
    ...
    "Grey Shrikethrush": "Grey Shrikethrush(灰鵙鹟)",
    ...
    "Grey-eyed Greenlet": "Grey-eyed Greenlet(灰眼绿莺雀)",
    ...
    "Grey-chested Greenlet": "Grey-chested Greenlet(灰胸绿莺雀)",
    ...
    "Grey-collared Oriole": "Grey-collared Oriole(灰领鹂)",
    "Black-eared Oriole": "Black-eared Oriole(黑耳鹂)",
    "Dusky-brown Oriole": "Dusky-brown Oriole(暗褐鹂)",
    ...
    "Western Oriole": "Western Oriole(西非黑头黄鹂)",
    "Sao Tome Oriole": "Sao Tome Oriole(白腹黄鹂)",
    "Black-headed Oriole": "Black-headed Oriole(东非黑头黄鹂)",
    "Ethiopian Oriole": "Ethiopian Oriole(黑头林黄鹂)",
    "Mountain Oriole": "Mountain Oriole(山鹂)",
    ...
    "Paradise Drongo": "Paradise Drongo(绶带卷尾)",
    ...
    "White-spotted Fantail": "White-spotted Fantail(白点扇尾鹟)",
    ...
    "Biak Fantail": "Biak Fantail(比岛扇尾鹟)",
    ...
    "Grey Fantail": "Grey Fantail(灰扇尾鹟)",
    ...
    "Makira Fantail": "Makira Fantail(暗色扇尾鹟)",
    ...
    "Blue-mantled Crested Flycatcher": "Blue-mantled Crested Flycatcher(非洲凤头鹟)",
    ...
    "Red-bellied Paradise Flycatcher": "Red-bellied Paradise Flycatcher(红腹寿带)",
    ...
    "Black Monarch": "Black Monarch(黑王鹟)",
    ...
    "Louisiade Monarch": "Louisiade Monarch(路易王鹟)",
    "Spectacled Monarch": "Spectacled Monarch(眼镜王鹟)",
    "Moluccan Monarch": "Moluccan Monarch(摩鹿加王鹟)",
    ...
    "Northern White-crowned Shrike": "Northern White-crowned Shrike(白腰林鵙)",
    "Southern White-crowned Shrike": "Southern White-crowned Shrike(白顶林鵙)",
    ...
    "Grey-backed Fiscal": "Grey-backed Fiscal(灰背长尾伯劳)",
    "Taita Fiscal": "Taita Fiscal(肯尼亚伯劳)",
    "Great Grey Shrike": "Great Grey Shrike(西方灰伯劳)",
    "Somali Fiscal": "Somali Fiscal(索马里伯劳)",
    "Loggerhead Shrike": "Loggerhead Shrike(呆头伯劳)",
    "Giant Grey Shrike": "Giant Grey Shrike(青藏楔尾伯劳)",
    "Chinese Grey Shrike": "Chinese Grey Shrike(楔尾伯劳)",
    "Iberian Grey Shrike": "Iberian Grey Shrike(伊比利亚灰伯劳)",
    "Northern Shrike": "Northern Shrike(灰伯劳)",
    "Masked Shrike": "Masked Shrike(云斑伯劳)",
    "Sao Tome Fiscal": "Sao Tome Fiscal(圣多美伯劳)",
    ...
    "Lesser Grey Shrike": "Lesser Grey Shrike(黑额伯劳)",
    ...
    "Grey-backed Shrike": "Grey-backed Shrike(灰背伯劳)",
    ...
    "Green Jay": "Green Jay(绿蓝鸦)",
    "Inca Jay": "Inca Jay(印加绿蓝鸦)",
    ...
    "Stresemann's Bushcrow": "Stresemann's Bushcrow(灰丛鸦)",
    ...
    "Alpine Chough": "Alpine Chough(黄嘴山鸦)",
    "Piapiac": "Piapiac(须嘴鸦)",
    "Western Jackdaw": "Western Jackdaw(寒鸦)",
    ...
    "Eastern Jungle Crow": "Eastern Jungle Crow(丛林鸦)",
    "Indian Jungle Crow": "Indian Jungle Crow(印度丛林鸦)",
    ...
    "Northern Raven": "Northern Raven(渡鸦)",
    ...
    "Blue-capped Ifrit": "Blue-capped Ifrit(蓝顶鹛鸫)",
    ...
    "Tagula Manucode": "Tagula Manucode(塔古极乐鸟)",
    ...
    "Princess Stephanie's Astrapia": "Princess Stephanie's Astrapia(公主长尾风鸟)",
    "Huon Astrapia": "Huon Astrapia(绿腹长尾风鸟)",
    "Western Parotia": "Western Parotia(阿法六线风鸟)",
    "Queen Carola's Parotia": "Queen Carola's Parotia(白胁六线风鸟)",
    ...
    "Standardwing": "Standardwing(幡羽极乐鸟)",
    ...
    "Mountain Robin": "Mountain Robin(林鸲鹟)",
    ...
    "Ashy Robin": "Ashy Robin(地丛鹟)",
    "Black-capped Robin": "Black-capped Robin(黑顶丛鹟)",
    "Grey-headed Robin": "Grey-headed Robin(灰头丛鹟)",
    ...
    "Yellow-bellied Fantail": "Yellow-bellied Fantail(黄腹扇尾鹟)",
    "Fairy Flycatcher": "Fairy Flycatcher(仙玉鹟)",
    "Grey-headed Canary-flycatcher": "Grey-headed Canary-flycatcher(方尾鹟)",
    ...
    "Grey-crested Tit": "Grey-crested Tit(褐冠山雀)",
    ...
    "Grey-headed Chickadee": "Grey-headed Chickadee(西伯利亚山雀)",
    ...
    "Acacia Tit": "Acacia Tit(索马里山雀)",
    "Miombo Tit": "Miombo Tit(北灰山雀)",
    "Ashy Tit": "Ashy Tit(阿卡山雀)",
    "Grey Tit": "Grey Tit(灰山雀)",
    ...
    "Grey Penduline Tit": "Grey Penduline Tit(非洲攀雀)",
    "Cape Penduline Tit": "Cape Penduline Tit(南攀雀)",
    "Verdin": "Verdin(黄头金雀)",
    ...
    "Benguela Long-billed Lark": "Benguela Long-billed Lark(本格拉歌百灵)",
    ...
    "Agulhas Long-billed Lark": "Agulhas Long-billed Lark(阿古歌百灵)",
    ...
    "Grey-backed Sparrow-Lark": "Grey-backed Sparrow-Lark(灰背雀百灵)",
    "Fischer's Sparrow-Lark": "Fischer's Sparrow-Lark(白颊雀百灵)",
    "Rusty Bush Lark": "Rusty Bush Lark(锈色歌百灵)",
    ...
    "Archer's Lark": "Archer's Lark(阿氏歌百灵)",
    ...
    "Singing Bush Lark": "Singing Bush Lark(歌百灵)",
    "Melodious Lark": "Melodious Lark(南非歌百灵)",
    "White-tailed Lark": "White-tailed Lark(白尾歌百灵)",
    "Burmese Bush Lark": "Burmese Bush Lark(缅甸歌百灵)",
    "Indochinese Bush Lark": "Indochinese Bush Lark(东洋歌百灵)",
    "Jerdon's Bush Lark": "Jerdon's Bush Lark(斯里兰卡歌百灵)",
    "Indian Bush Lark": "Indian Bush Lark(印度歌百灵)",
    "Bengal Bush Lark": "Bengal Bush Lark(棕翅歌百灵)",
    ...
    "Maghreb Lark": "Maghreb Lark(马格里布凤头百灵)",
    "Horned Lark": "Horned Lark(角百灵)",
    "Temminck's Lark": "Temminck's Lark(漠角百灵)",
    "Hume's Short-toed Lark": "Hume's Short-toed Lark(细嘴短趾百灵)",
    ...
    "Grey-headed Bristlebill": "Grey-headed Bristlebill(灰头须鹎)",
    ...
    "Swamp Palm Bulbul": "Swamp Palm Bulbul(沼泽鹎)",
    "Joyful Greenbul": "Joyful Greenbul(娇绿鸫鹎)",
    "Prigogine's Greenbul": "Prigogine's Greenbul(普氏绿鸫鹎)",
    "Falkenstein's Greenbul": "Falkenstein's Greenbul(黄颈绿鸫鹎)",
    ...
    "Kakamega Greenbul": "Kakamega Greenbul(卡卡梅加绿鹎)",
    ...
    "Little Grey Greenbul": "Little Grey Greenbul(灰绿鹎)",
    "Ansorge's Greenbul": "Ansorge's Greenbul(安氏绿鹎)",
    "Lowland Tiny Greenbul": "Lowland Tiny Greenbul(姬旋木鹎)",
    "Montane Tiny Greenbul": "Montane Tiny Greenbul(山地姬旋木鹎)",
    ...
    "Grey-olive Greenbul": "Grey-olive Greenbul(灰绿旋木鹎)",
    "Fischer's Greenbul": "Fischer's Greenbul(费氏旋木鹎)",
    "Cabanis's Greenbul": "Cabanis's Greenbul(卡氏旋木鹎)",
    "Leaf-love": "Leaf-love(旋木鹎)",
    "Sassi's Olive Greenbul": "Sassi's Olive Greenbul(洛氏旋木鹎)",
    "Yellow-streaked Greenbul": "Yellow-streaked Greenbul(黄纹旋木鹎)",
    "Sharpe's Greenbul": "Sharpe's Greenbul(夏氏旋木鹎)",
    "Grey-headed Greenbul": "Grey-headed Greenbul(灰头旋木鹎)",
    "Toro Olive Greenbul": "Toro Olive Greenbul(托罗绿旋木鹎)",
    "Baumann's Olive Greenbul": "Baumann's Olive Greenbul(包氏旋木鹎)",
    ...
    "Palawan Bulbul": "Palawan Bulbul(巴拉望冠鹎)",
    "Grey-cheeked Bulbul": "Grey-cheeked Bulbul(灰颊冠鹎)",
    ...
    "Grey-eyed Bulbul": "Grey-eyed Bulbul(灰眼短脚鹎)",
    ...
    "Grey-headed Bulbul": "Grey-headed Bulbul(灰头鹎)",
    ...
    "Grey-bellied Bulbul": "Grey-bellied Bulbul(灰腹鹎)",
    ...
    "Asian Red-eyed Bulbul": "Asian Red-eyed Bulbul(红眼褐鹎)",
    ...
    "African Red-eyed Bulbul": "African Red-eyed Bulbul(红眼鹎)",
    ...
    "Square-tailed Saw-wing": "Square-tailed Saw-wing(方尾锯翅燕)",
    "White-headed Saw-wing": "White-headed Saw-wing(白头锯翅燕)",
    "Mountain Saw-wing": "Mountain Saw-wing(山地锯翅燕)",
    "Black Saw-wing": "Black Saw-wing(蓝锯翅燕)",
    "Fanti Saw-wing": "Fanti Saw-wing(叉尾锯翅燕)",
    "Grey-rumped Swallow": "Grey-rumped Swallow(灰腰燕)",
    ...
    "Brown-throated Martin": "Brown-throated Martin(非洲褐喉沙燕)",
    "Madagascar Martin": "Madagascar Martin(马岛褐喉沙燕)",
    "Grey-throated Martin": "Grey-throated Martin(灰喉沙燕)",
    "Congo Martin": "Congo Martin(刚果沙燕)",
    "Sand Martin": "Sand Martin(崖沙燕)",
    ...
    "Grey-breasted Martin": "Grey-breasted Martin(灰胸崖燕)",
    ...
    "Red-throated Rock Martin": "Red-throated Rock Martin(红喉岩燕)",
    "Large Rock Martin": "Large Rock Martin(非洲岩燕)",
    "Dusky Crag Martin": "Dusky Crag Martin(纯色岩燕)",
    "Blue Swallow": "Blue Swallow(蓝燕)",
    ...
    "White-bibbed Swallow": "White-bibbed Swallow(白喉蓝燕)",
    ...
    "Red-breasted Swallow": "Red-breasted Swallow(褐胸燕)",
    "Mosque Swallow": "Mosque Swallow(塞内加尔燕)",
    "Red-throated Cliff Swallow": "Red-throated Cliff Swallow(红喉燕)",
    "Preuss's Cliff Swallow": "Preuss's Cliff Swallow(普氏燕)",
    "Red Sea Cliff Swallow": "Red Sea Cliff Swallow(红海燕)",
    "South African Cliff Swallow": "South African Cliff Swallow(非洲斑燕)",
    "Streak-throated Swallow": "Streak-throated Swallow(黄额燕)",
    "Fairy Martin": "Fairy Martin(彩石燕)",
    "Tree Martin": "Tree Martin(树燕)",
    "American Cliff Swallow": "American Cliff Swallow(美洲燕)",
    ...
    "Nepal Cupwing": "Nepal Cupwing(尼泊尔鹪鹛)",
    ...
    "Grey Longbill": "Grey Longbill(灰长嘴莺)",
    ...
    "Philippa's Crombec": "Philippa's Crombec(短嘴森莺)",
    ...
    "Shade Bush Warbler": "Shade Bush Warbler(所罗门树莺)",
    "Bougainville Bush Warbler": "Bougainville Bush Warbler(布岛树莺)",
    "Fiji Bush Warbler": "Fiji Bush Warbler(斐济树莺)",
    "Brown-flanked Bush Warbler": "Brown-flanked Bush Warbler(强脚树莺)",
    "Hume's Bush Warbler": "Hume's Bush Warbler(喜山黄腹树莺)",
    "Yellow-bellied Bush Warbler": "Yellow-bellied Bush Warbler(黄腹树莺)",
    "Aberrant Bush Warbler": "Aberrant Bush Warbler(异色树莺)",
    "Grey-bellied Tesia": "Grey-bellied Tesia(灰腹地莺)",
    ...
    "Grey-sided Bush Warbler": "Grey-sided Bush Warbler(棕顶树莺)",
    ...
    "Streaked Scrub Warbler": "Streaked Scrub Warbler(纹鹪莺)",
    "Little Yellow Flycatcher": "Little Yellow Flycatcher(黄红鹟)",
    ...
    "American Bushtit": "American Bushtit(短嘴长尾山雀)",
    "Long-tailed Tit": "Long-tailed Tit(北长尾山雀)",
    "Silver-throated Bushtit": "Silver-throated Bushtit(银喉长尾山雀)",
    "White-cheeked Bushtit": "White-cheeked Bushtit(白颊长尾山雀)",
    "Pygmy Bushtit": "Pygmy Bushtit(侏长尾山雀)",
    "Black-throated Bushtit": "Black-throated Bushtit(红头长尾山雀)",
    "White-throated Bushtit": "White-throated Bushtit(白喉长尾山雀)",
    "Rufous-fronted Bushtit": "Rufous-fronted Bushtit(棕额长尾山雀)",
    "Black-browed Bushtit": "Black-browed Bushtit(黑眉长尾山雀)",
    "Sooty Bushtit": "Sooty Bushtit(银脸长尾山雀)",
    ...
    "Hume's Leaf Warbler": "Hume's Leaf Warbler(淡眉柳莺)",
    ...
    "Grey-cheeked Warbler": "Grey-cheeked Warbler(灰脸鹟莺)",
    "Green-crowned Warbler": "Green-crowned Warbler(金眶鹟莺)",
    "Grey-crowned Warbler": "Grey-crowned Warbler(灰冠鹟莺)",
    ...
    "Anjouan Brush Warbler": "Anjouan Brush Warbler(安岛薮莺)",
    ...
    "Cape Verde Warbler": "Cape Verde Warbler(佛得角苇莺)",
    ...
    "Speckled Reed Warbler": "Speckled Reed Warbler(细纹苇莺)",
    ...
    "Styan's Grasshopper Warbler": "Styan's Grasshopper Warbler(东亚蝗莺)",
    ...
    "New Britain Thicketbird": "New Britain Thicketbird(俾斯麦草莺)",
    "Buff-banded Thicketbird": "Buff-banded Thicketbird(黄斑草莺)",
    ...
    "Bangwa Forest Warbler": "Bangwa Forest Warbler(班戈短翅莺)",
    ...
    "Grey Emutail": "Grey Emutail(灰短翅莺)",
    "Brown Emutail": "Brown Emutail(褐短翅莺)",
    "Dja River Scrub Warbler": "Dja River Scrub Warbler(沼泽短翅莺)",
    ...
    "Grey-crowned Tetraka": "Grey-crowned Tetraka(灰冠旋木鹎)",
    ...
    "Grey-backed Cisticola": "Grey-backed Cisticola(灰背扇尾莺)",
    ...
    "Short-winged Cisticola": "Short-winged Cisticola(短翅扇尾莺)",
    "Rufous Cisticola": "Rufous Cisticola(褐扇尾莺)",
    "Foxy Cisticola": "Foxy Cisticola(狐色扇尾莺)",
    "Neddicky": "Neddicky(笛声扇尾莺)",
    "Long-tailed Cisticola": "Long-tailed Cisticola(塔伯扇尾莺)",
    "Black-tailed Cisticola": "Black-tailed Cisticola(细尾扇尾莺)",
    ...
    "Grey-crowned Prinia": "Grey-crowned Prinia(霍氏山鹪莺)",
    "Rufous-fronted Prinia": "Rufous-fronted Prinia(棕额山鹪莺)",
    "Rufescent Prinia": "Rufescent Prinia(暗冕山鹪莺)",
    "Grey-breasted Prinia": "Grey-breasted Prinia(灰胸山鹪莺)",
    ...
    "Visayan Miniature Babbler": "Visayan Miniature Babbler(小雀莺)",
    "Mindanao Miniature Babbler": "Mindanao Miniature Babbler(棉兰雀莺)",
    "Green Longtail": "Green Longtail(绿长尾莺)",
    "Black-collared Apalis": "Black-collared Apalis(黑领娇莺)",
    "Rwenzori Apalis": "Rwenzori Apalis(领娇莺)",
    "Red-winged Grey Warbler": "Red-winged Grey Warbler(红翅灰莺)",
    "Cricket Warbler": "Cricket Warbler(蟋蟀鹪莺)",
    ...
    "Brown-tailed Apalis": "Brown-tailed Apalis(褐尾娇莺)",
    "Yellow-breasted Apalis": "Yellow-breasted Apalis(黄胸娇莺)",
    "Lowland Masked Apalis": "Lowland Masked Apalis(隐娇莺)",
    "Mountain Masked Apalis": "Mountain Masked Apalis(黑脸娇莺)",
    ...
    "Grey-capped Warbler": "Grey-capped Warbler(灰顶莺)",
    "Grey-backed Camaroptera": "Grey-backed Camaroptera(灰背拱翅莺)",
    ...
    "Grey Wren-Warbler": "Grey Wren-Warbler(灰拱翅莺)",
    ...
    "Black-headed Rufous Warbler": "Black-headed Rufous Warbler(黑头棕莺)",
    "Black-faced Rufous Warbler": "Black-faced Rufous Warbler(黑脸棕莺)",
    "Winifred's Warbler": "Winifred's Warbler(莫氏莺)",
    ...
    "Grey-backed Tailorbird": "Grey-backed Tailorbird(灰背缝叶莺)",
    ...
    "Black-headed Tailorbird": "Black-headed Tailorbird(黑头缝叶莺)",
    "Yellow-breasted Tailorbird": "Yellow-breasted Tailorbird(萨马缝叶莺)",
    "Long-billed Forest Warbler": "Long-billed Forest Warbler(长嘴缝叶莺)",
    "Red-capped Forest Warbler": "Red-capped Forest Warbler(红顶缝叶莺)",
    ...
    "Burnt-necked Eremomela": "Burnt-necked Eremomela(褐喉孤莺)",
    ...
    "Dohrn's Warbler": "Dohrn's Warbler(多氏仙鹟)",
    ...
    "Common Whitethroat": "Common Whitethroat(灰白喉林莺)",
    ...
    "Grey-hooded Fulvetta": "Grey-hooded Fulvetta(灰头雀鹛)",
    ...
    "Grey-headed Parrotbill": "Grey-headed Parrotbill(灰头鸦雀)",
    ...
    "Grey-hooded Parrotbill": "Grey-hooded Parrotbill(暗色鸦雀)",
    ...
    "Przevalski's Parrotbill": "Przevalski's Parrotbill(灰冠鸦雀)",
    ...
    "Grey-hooded Heleia": "Grey-hooded Heleia(灰巾冠绣眼鸟)",
    ...
    "Mountain Blackeye": "Mountain Blackeye(绿绣眼鸟)",
    ...
    "Karthala White-eye": "Karthala White-eye(科摩罗绣眼鸟)",
    "Reunion Olive White-eye": "Reunion Olive White-eye(橄揽绣眼鸟)",
    "Mauritius Olive White-eye": "Mauritius Olive White-eye(毛里求斯绣眼鸟)",
    "Reunion Grey White-eye": "Reunion Grey White-eye(留尼汪灰绣眼鸟)",
    "Mauritius Grey White-eye": "Mauritius Grey White-eye(毛岛灰绣眼鸟)",
    "Mount Cameroon Speirops": "Mount Cameroon Speirops(喀麦隆绣眼鸟)",
    "Forest White-eye": "Forest White-eye(林绣眼鸟)",
    "Green White-eye": "Green White-eye(绿黄绣眼鸟)",
    "Broad-ringed White-eye": "Broad-ringed White-eye(宽颈绣眼鸟)",
    "Fernando Po Speirops": "Fernando Po Speirops(褐绣眼鸟)",
    ...
    "Pale-bellied White-eye": "Pale-bellied White-eye(淡腹绣眼鸟)",
    "Togian White-eye": "Togian White-eye(托岛绣眼鸟)",
    "Black-ringed White-eye": "Black-ringed White-eye(柠喉绣眼鸟)",
    "Green-fronted White-eye": "Green-fronted White-eye(绿额绣眼鸟)",
    "Black-fronted White-eye": "Black-fronted White-eye(黑额绣眼鸟)",
    ...
    "Canary White-eye": "Canary White-eye(澳洲黄绣眼鸟)",
    ...
    "Vella Lavella White-eye": "Vella Lavella White-eye(斑绣眼鸟)",
    "Santa Cruz White-eye": "Santa Cruz White-eye(圣岛绣眼鸟)",
    "Capped White-eye": "Capped White-eye(黄腹绣眼鸟)",
    "Oya Tabu White-eye": "Oya Tabu White-eye(当岛绣眼鸟)",
    "Vanuatu White-eye": "Vanuatu White-eye(黄额绣眼鸟)",
    ...
    "Bismarck White-eye": "Bismarck White-eye(黑头绣眼鸟)",
    ...
    "Olive-colored White-eye": "Olive-colored White-eye(雅岛绣眼鸟)",
    "Dusky White-eye": "Dusky White-eye(暗绣眼鸟)",
    "Grey-brown White-eye": "Grey-brown White-eye(灰绣眼鸟)",
    ...
    "Christmas White-eye": "Christmas White-eye(圣诞岛绣眼鸟)",
    "Bridled White-eye": "Bridled White-eye(马里亚纳绣眼鸟)",
    "Citrine White-eye": "Citrine White-eye(卡岛绣眼鸟)",
    ...
    "Grey-faced Tit-Babbler": "Grey-faced Tit-Babbler(灰脸纹胸鹛)",
    "Grey-cheeked Tit-Babbler": "Grey-cheeked Tit-Babbler(黄领纹胸鹛)",
    ...
    "Grey-hooded Babbler": "Grey-hooded Babbler(灰冠穗鹛)",
    ...
    "Grey-bellied Wren-Babbler": "Grey-bellied Wren-Babbler(灰腹鹩鹛)",
    ...
    "Grey-sided Scimitar Babbler": "Grey-sided Scimitar Babbler(华南斑胸钩嘴鹛)",
    ...
    "Grey-throated Babbler": "Grey-throated Babbler(黑头穗鹛)",
    "Grey-headed Babbler": "Grey-headed Babbler(灰头穗鹛)",
    ...
    "Grey-breasted Babbler": "Grey-breasted Babbler(灰头树鹛)",
    ...
    "Melodious Babbler": "Melodious Babbler(巴拉望树鹛)",
    ...
    "Golden-fronted Fulvetta": "Golden-fronted Fulvetta(金额雀鹛)",
    ...
    "Mourning Babbler": "Mourning Babbler(短尾雅鹛)",
    "Glissando Babbler": "Glissando Babbler(滑音短尾雅鹛)",
    "Leaflitter Babbler": "Leaflitter Babbler(灰颊短尾雅鹛)",
    ...
    "Malayan Swamp Babbler": "Malayan Swamp Babbler(白胸雅鹛)",
    "Bornean Swamp Babbler": "Bornean Swamp Babbler(婆罗洲雅鹛)",
    ...
    "Spotted Thrush-Babbler": "Spotted Thrush-Babbler(白腹鸫鹛)",
    ...
    "Grey-cheeked Fulvetta": "Grey-cheeked Fulvetta(台湾雀鹛)",
    ...
    "Grey-crowned Crocias": "Grey-crowned Crocias(灰冠南洋鹛)",
    ...
    "Brown-cheeked Laughingthrush": "Brown-cheeked Laughingthrush(灰腹噪鹛)",
    ...
    "Grey Sibia": "Grey Sibia(灰奇鹛)",
    "Dark-backed Sibia": "Dark-backed Sibia(黑背奇鹛)",
    ...
    "Bar-throated Minla": "Bar-throated Minla(斑喉希鹛)",
    ...
    "Large Grey Babbler": "Large Grey Babbler(灰鸫鹛)",
    ...
    "Fulvous Babbler": "Fulvous Babbler(棕褐鸫鹛)",
    ...
    "Chapin's Babbler": "Chapin's Babbler(查氏鹟鹛)",
    "Red-collared Babbler": "Red-collared Babbler(棕颈鹟鹛)",
    "Brown Babbler": "Brown Babbler(非洲褐鸫鹛)",
    "White-rumped Babbler": "White-rumped Babbler(白腰鸫鹛)",
    "Hinde's Babbler": "Hinde's Babbler(海氏斑鸫鹛)",
    ...
    "White-headed Babbler": "White-headed Babbler(白头鸫鹛)",
    ...
    "Grey Laughingthrush": "Grey Laughingthrush(褐胸噪鹛)",
    ...
    "White-speckled Laughingthrush": "White-speckled Laughingthrush(白点噪鹛)",
    ...
    "Plain Laughingthrush": "Plain Laughingthrush(山噪鹛)",
    ...
    "Grey-sided Laughingthrush": "Grey-sided Laughingthrush(灰胁噪鹛)",
    ...
    "Grey-chested Babbler": "Grey-chested Babbler(灰胸雅鹛)",
    ...
    "Grey-barred Wren": "Grey-barred Wren(灰斑曲嘴鹪鹩)",
    ...
    "Grey-mantled Wren": "Grey-mantled Wren(灰背锯嘴鹪鹩)",
    ...
    "Sepia-brown Wren": "Sepia-brown Wren(夏氏鹪鹩)",
    ...
    "Grey-browed Wren": "Grey-browed Wren(灰眉苇鹪鹩)",
    ...
    "Grey-breasted Wood Wren": "Grey-breasted Wood Wren(灰胸林鹩)",
    ...
    "Northern Nightingale-Wren": "Northern Nightingale-Wren(夜莺鹪鹩)",
    "Southern Nightingale-Wren": "Southern Nightingale-Wren(鳞胸鹪鹩)",
    ...
    "Trilling Gnatwren": "Trilling Gnatwren(长嘴蚋莺)",
    ...
    "Para Gnatcatcher": "Para Gnatcatcher(帕拉蚋莺)",
    ...
    "Maranon Gnatcatcher": "Maranon Gnatcatcher(马谷蚋莺)",
    ...
    "Blue-grey Gnatcatcher": "Blue-grey Gnatcatcher(灰蓝蚋莺)",
    ...
    "Chinese Nuthatch": "Chinese Nuthatch(黑头䴓)",
    ...
    "Espanola Mockingbird": "Espanola Mockingbird(冠嘲鸫)",
    ...
    "Grey Thrasher": "Grey Thrasher(灰弯嘴嘲鸫)",
    ...
    "Grey Trembler": "Grey Trembler(灰旋木嘲鸫)",
    "Metallic Starling": "Metallic Starling(群辉椋鸟)",
    "Violet-hooded Starling": "Violet-hooded Starling(紫冠辉椋鸟)",
    ...
    "Mauke Starling": "Mauke Starling(奇辉椋鸟)",
    ...
    "Fiery-browed Starling": "Fiery-browed Starling(火眉红椋鸟)",
    "Grosbeak Starling": "Grosbeak Starling(雀嘴八哥)",
    "Spot-winged Starling": "Spot-winged Starling(斑翅椋鸟)",
    "Golden-crested Myna": "Golden-crested Myna(金冠树八哥)",
    "Sri Lanka Hill Myna": "Sri Lanka Hill Myna(斯里兰卡鹩哥)",
    "Common Hill Myna": "Common Hill Myna(鹩哥)",
    "Nias Hill Myna": "Nias Hill Myna(尼岛鹩哥)",
    ...
    "Indian Pied Myna": "Indian Pied Myna(斑椋鸟)",
    "Siamese Pied Myna": "Siamese Pied Myna(暹罗斑椋鸟)",
    "Javan Pied Myna": "Javan Pied Myna(爪哇斑椋鸟)",
    ...
    "Pied Starling": "Pied Starling(非洲丽椋鸟)",
    ...
    "Finsch's Rufous Thrush": "Finsch's Rufous Thrush(芬氏蚁鸫)",
    "Fraser's Rufous Thrush": "Fraser's Rufous Thrush(弗氏蚁鸫)",
    ...
    "Grey-cheeked Thrush": "Grey-cheeked Thrush(灰颊夜鸫)",
    ...
    "Grey Ground Thrush": "Grey Ground Thrush(灰色地鸫)",
    ...
    "Orange-sided Thrush": "Orange-sided Thrush(橙斑地鸫)",
    ...
    "Red-backed Thrush": "Red-backed Thrush(红背地鸫)",
    ...
    "Grey-backed Thrush": "Grey-backed Thrush(灰背鸫)",
    "Eyebrowed Thrush": "Eyebrowed Thrush(白眉鸫)",
    "Pale Thrush": "Pale Thrush(白腹鸫)",
    "Grey-sided Thrush": "Grey-sided Thrush(褐头鸫)",
    ...
    "Rufous-collared Thrush": "Rufous-collared Thrush(中美棕颈鸫)",
    ...
    "Maranon Thrush": "Maranon Thrush(马谷鸫)",
    ...
    "Rufous-backed Thrush": "Rufous-backed Thrush(棕背鸲鸫)",
    ...
    "Fraser's Forest Flycatcher": "Fraser's Forest Flycatcher(非洲森鹟)",
    "Grey-throated Tit-Flycatcher": "Grey-throated Tit-Flycatcher(灰喉雀鹟)",
    "Grey Tit-Flycatcher": "Grey Tit-Flycatcher(灰雀鹟)",
    ...
    "African Grey Flycatcher": "African Grey Flycatcher(非洲灰鹟)",
    ...
    "Humblot's Flycatcher": "Humblot's Flycatcher(哈氏鹟)",
    "Grey-streaked Flycatcher": "Grey-streaked Flycatcher(灰纹鹟)",
    ...
    "Sulawesi Streaked Flycatcher": "Sulawesi Streaked Flycatcher(苏拉威西斑鹟)",
    "Yellow-footed Flycatcher": "Yellow-footed Flycatcher(黄脚鹟)",
    "Little Grey Flycatcher": "Little Grey Flycatcher(小灰鹟)",
    "African Dusky Flycatcher": "African Dusky Flycatcher(暗鹟)",
    "Spotted Flycatcher": "Spotted Flycatcher(斑鹟)",
    "Mediterranean Flycatcher": "Mediterranean Flycatcher(地中海斑鹟)",
    ...
    "Nilgiri Blue Robin": "Nilgiri Blue Robin(棕胁蓝地鸲)",
    "White-bellied Blue Robin": "White-bellied Blue Robin(白腹蓝地鸲)",
    ...
    "Matinan Blue Flycatcher": "Matinan Blue Flycatcher(山氏仙鹟)",
    "Blue-fronted Blue Flycatcher": "Blue-fronted Blue Flycatcher(蓝额仙鹟)",
    ...
    "Blue-throated Blue Flycatcher": "Blue-throated Blue Flycatcher(蓝喉仙鹟)",
    ...
    "Grey-chested Jungle Flycatcher": "Grey-chested Jungle Flycatcher(灰胸林鹟)",
    ...
    "Spotted Palm Thrush": "Spotted Palm Thrush(斑晨鸫)",
    ...
    "Archer's Ground Robin": "Archer's Ground Robin(阿氏歌䳭)",
    "Olive-flanked Ground Robin": "Olive-flanked Ground Robin(绿胁歌䳭)",
    ...
    "Grey-winged Robin-Chat": "Grey-winged Robin-Chat(灰翅歌䳭)",
    ...
    "Sumatran Blue Robin": "Sumatran Blue Robin(苏门答腊蓝地鸲)",
    "Javan Blue Robin": "Javan Blue Robin(蓝地鸲)",
    ...
    "Brown-winged Whistling Thrush": "Brown-winged Whistling Thrush(褐翅啸鸫)",
    ...
    "White-throated Jungle Flycatcher": "White-throated Jungle Flycatcher(黑林鹟)",
    "White-browed Jungle Flycatcher": "White-browed Jungle Flycatcher(吕宋林鹟)",
    "Slaty-backed Jungle Flycatcher": "Slaty-backed Jungle Flycatcher(棉岛林鹟)",
    "Bagobo Babbler": "Bagobo Babbler(菲律宾鹛鸫)",
    ...
    "Atlas Pied Flycatcher": "Atlas Pied Flycatcher(非洲斑姬鹟)",
    ...
    "Eversmann's Redstart": "Eversmann's Redstart(红背红尾鸲)",
    ...
    "Plumbeous Water Redstart": "Plumbeous Water Redstart(红尾水鸲)",
    "Luzon Water Redstart": "Luzon Water Redstart(吕宋水鸲)",
    "White-capped Redstart": "White-capped Redstart(白顶溪鸲)",
    "Przevalski's Redstart": "Przevalski's Redstart(贺兰山红尾鸲)",
    ...
    "Güldenstädt's Redstart": "Güldenstädt's Redstart(红腹红尾鸲)",
    ...
    "Common Rock Thrush": "Common Rock Thrush(白背矶鸫)",
    ...
    "Jerdon's Bush Chat": "Jerdon's Bush Chat(黑白林䳭)",
    "Grey Bush Chat": "Grey Bush Chat(灰林䳭)",
    "Whinchat": "Whinchat(草原石䳭)",
    "White-browed Bush Chat": "White-browed Bush Chat(大嘴石䳭)",
    "White-bellied Bush Chat": "White-bellied Bush Chat(帝汶林䳭)",
    "Pied Bush Chat": "Pied Bush Chat(白斑黑石䳭)",
    "White-throated Bush Chat": "White-throated Bush Chat(白喉石䳭)",
    ...
    "Canary Islands Stonechat": "Canary Islands Stonechat(加纳利石䳭)",
    ...
    "Anteater Chat": "Anteater Chat(蚁䳭)",
    "Congo Moor Chat": "Congo Moor Chat(刚果蚁䳭)",
    "Ant-eating Chat": "Ant-eating Chat(南方蚁䳭)",
    "Mountain Chat": "Mountain Chat(山䳭)",
    "Sooty Chat": "Sooty Chat(暗色蚁䳭)",
    "Rüppell's Black Chat": "Rüppell's Black Chat(黑蚁䳭)",
    "Ruaha Chat": "Ruaha Chat(西非蚁䳭)",
    ...
    "Brown-tailed Rock Chat": "Brown-tailed Rock Chat(褐尾岩䳭)",
    ...
    "Maghreb Wheatear": "Maghreb Wheatear(马格里布䳭)",
    "Mourning Wheatear": "Mourning Wheatear(悲䳭)",
    "Basalt Wheatear": "Basalt Wheatear(深灰䳭)",
    "Kurdish Wheatear": "Kurdish Wheatear(黑脸红尾䳭)",
    "Red-tailed Wheatear": "Red-tailed Wheatear(红尾䳭)",
    ...
    "Legge's Flowerpecker": "Legge's Flowerpecker(白喉啄花鸟)",
    ...
    "Grey-sided Flowerpecker": "Grey-sided Flowerpecker(灰胁啄花鸟)",
    ...
    "Grey-headed Sunbird": "Grey-headed Sunbird(灰头太阳鸟)",
    ...
    "Grey-throated Sunbird": "Grey-throated Sunbird(灰喉食蜜鸟)",
    "Red-throated Sunbird": "Red-throated Sunbird(棕喉食蜜鸟)",
    "Mangrove Sunbird": "Mangrove Sunbird(灰褐食蜜鸟)",
    ...
    "Grey-chinned Sunbird": "Grey-chinned Sunbird(灰颏绿食蜜鸟)",
    "Banded Green Sunbird": "Banded Green Sunbird(红领食蜜鸟)",
    ...
    "Giant Sunbird": "Giant Sunbird(巨花蜜鸟)",
    ...
    "Grey Sunbird": "Grey Sunbird(灰褐花蜜鸟)",
    ...
    "Scarlet-tufted Sunbird": "Scarlet-tufted Sunbird(红簇花蜜鸟)",
    ...
    "Rwenzori Double-collared Sunbird": "Rwenzori Double-collared Sunbird(施氏花蜜鸟)",
    "Whyte's Double-collared Sunbird": "Whyte's Double-collared Sunbird(怀特双领花蜜鸟)",
    "Prigogine's Double-collared Sunbird": "Prigogine's Double-collared Sunbird(普氏花蜜鸟)",
    "Ludwig's Double-collared Sunbird": "Ludwig's Double-collared Sunbird(山林双领花蜜鸟)",
    ...
    "Malagasy Green Sunbird": "Malagasy Green Sunbird(马岛花蜜鸟)",
    ...
    "Grey-hooded Sunbird": "Grey-hooded Sunbird(哈氏太阳鸟)",
    ...
    "Grey-breasted Spiderhunter": "Grey-breasted Spiderhunter(灰胸捕蛛鸟)",
    ...
    "Kordofan Sparrow": "Kordofan Sparrow(苏丹麻雀)",
    "Shelley's Sparrow": "Shelley's Sparrow(白尼罗河麻雀)",
    "Kenya Sparrow": "Kenya Sparrow(肯尼亚麻雀)",
    "Great Sparrow": "Great Sparrow(棕麻雀)",
    "Northern Grey-headed Sparrow": "Northern Grey-headed Sparrow(灰头麻雀)",
    ...
    "Southern Grey-headed Sparrow": "Southern Grey-headed Sparrow(南非灰头麻雀)",
    ...
    "Iago Sparrow": "Iago Sparrow(棕背麻雀)",
    ...
    "Grey-capped Social Weaver": "Grey-capped Social Weaver(灰头群织雀)",
    "Black-capped Social Weaver": "Black-capped Social Weaver(黑头群织雀)",
    "Sociable Weaver": "Sociable Weaver(群织雀)",
    "Scaly-feathered Weaver": "Scaly-feathered Weaver(鳞额编织雀)",
    "Speckle-fronted Weaver": "Speckle-fronted Weaver(点额织雀)",
    "Thick-billed Weaver": "Thick-billed Weaver(厚嘴织雀)",
    ...
    "Eastern Golden Weaver": "Eastern Golden Weaver(东非织巢鸟)",
    ...
    "Taveta Weaver": "Taveta Weaver(栗头金织雀)",
    "Principe Weaver": "Principe Weaver(普岛金织雀)",
    ...
    "Lufira Masked Weaver": "Lufira Masked Weaver(刚果黑额织雀)",
    "Tanzanian Masked Weaver": "Tanzanian Masked Weaver(坦桑黑脸织雀)",
    ...
    "Cassin's Malimbe": "Cassin's Malimbe(黑喉精织雀)",
    ...
    "Comoro Fody": "Comoro Fody(马岛红头织雀)",
    ...
    "Black-winged Red Bishop": "Black-winged Red Bishop(黑翅巧织雀)",
    ...
    "Montane Widowbird": "Montane Widowbird(淡黄肩织雀)",
    ...
    "Pictorella Mannikin": "Pictorella Mannikin(斑胸文鸟)",
    ...
    "Madagascar Mannikin": "Madagascar Mannikin(马岛文鸟)",
    ...
    "Streak-headed Mannikin": "Streak-headed Mannikin(纹头文鸟)",
    "White-spotted Mannikin": "White-spotted Mannikin(白斑文鸟)",
    ...
    "Great-billed Mannikin": "Great-billed Mannikin(大嘴文鸟)",
    "Black-breasted Mannikin": "Black-breasted Mannikin(黑胸文鸟)",
    "Western Alpine Mannikin": "Western Alpine Mannikin(雪山文鸟)",
    "Eastern Alpine Mannikin": "Eastern Alpine Mannikin(高山文鸟)",
    "Grey-banded Mannikin": "Grey-banded Mannikin(灰带文鸟)",
    "Grey-crowned Mannikin": "Grey-crowned Mannikin(灰冠文鸟)",
    "Grey-headed Mannikin": "Grey-headed Mannikin(灰头文鸟)",
    "Hooded Mannikin": "Hooded Mannikin(黑巾文鸟)",
    "Forbes's Mannikin": "Forbes's Mannikin(栗背文鸟)",
    "Mottled Mannikin": "Mottled Mannikin(杂色文鸟)",
    "New Hanover Mannikin": "New Hanover Mannikin(新汉诺威文鸟)",
    "Yellow-rumped Mannikin": "Yellow-rumped Mannikin(黄尾文鸟)",
    "Five-colored Munia": "Five-colored Munia(五彩文鸟)",
    "Chestnut-breasted Mannikin": "Chestnut-breasted Mannikin(栗胸文鸟)",
    "Black Mannikin": "Black Mannikin(黑文鸟)",
    "Buff-bellied Mannikin": "Buff-bellied Mannikin(太平洋文鸟)",
    ...
    "Royal Parrotfinch": "Royal Parrotfinch(皇鹦雀)",
    "Red-headed Parrotfinch": "Red-headed Parrotfinch(红头鹦雀)",
    ...
    "Green Twinspot": "Green Twinspot(绿背斑雀)",
    ...
    "Grey-headed Nigrita": "Grey-headed Nigrita(灰冠黑雀)",
    "Pale-fronted Nigrita": "Pale-fronted Nigrita(淡额黑雀)",
    "Grey-headed Oliveback": "Grey-headed Oliveback(灰头绿背织雀)",
    ...
    "Grey Waxbill": "Grey Waxbill(黑尾梅花雀)",
    ...
    "Locust Finch": "Locust Finch(蝗鹑雀)",
    "Cut-throat Finch": "Cut-throat Finch(环喉雀)",
    "Red-headed Finch": "Red-headed Finch(红头环喉雀)",
    "Green Avadavat": "Green Avadavat(绿梅花雀)",
    "Orange-breasted Waxbill": "Orange-breasted Waxbill(橙胸梅花雀)",
    "Red Avadavat": "Red Avadavat(红梅花雀)",
    "Purple Grenadier": "Purple Grenadier(紫蓝饰雀)",
    "Violet-eared Waxbill": "Violet-eared Waxbill(紫耳蓝饰雀)",
    "Blue Waxbill": "Blue Waxbill(蓝饰雀)",
    "Red-cheeked Cordon-bleu": "Red-cheeked Cordon-bleu(红颊蓝饰雀)",
    "Blue-capped Cordon-bleu": "Blue-capped Cordon-bleu(蓝顶蓝饰雀)",
    ...
    "Yellow-winged Pytilia": "Yellow-winged Pytilia(黄翅斑腹雀)",
    ...
    "Zambezi Indigobird": "Zambezi Indigobird(双斑维达雀)",
    ...
    "Long-tailed Paradise Whydah": "Long-tailed Paradise Whydah(乐园维达雀)",
    ...
    "Cuckoo-finch": "Cuckoo-finch(寄生维达雀)",
    ...
    "Kozlov's Accentor": "Kozlov's Accentor(贺兰山岩鹨)",
    "Dunnock": "Dunnock(林岩鹨)",
    ...
    "Sao Tome Shorttail": "Sao Tome Shorttail(圣多美鹡鸰)",
    "Grey Wagtail": "Grey Wagtail(灰鹡鸰)",
    ...
    "Cape Longclaw": "Cape Longclaw(橙喉长爪鹡鸰)",
    ...
    "European Rock Pipit": "European Rock Pipit(石鹨)",
    ...
    "African Rock Pipit": "African Rock Pipit(南非石鹨)",
    "Short-tailed Pipit": "Short-tailed Pipit(短尾鹨)",
    "Bushveld Pipit": "Bushveld Pipit(南非鹨)",
    ...
    "Przevalski's Finch": "Przevalski's Finch(朱鹀)",
    "Eurasian Chaffinch": "Eurasian Chaffinch(苍头燕雀)",
    ...
    "Chinese Grosbeak": "Chinese Grosbeak(黑尾蜡嘴雀)",
    ...
    "Grey-headed Bullfinch": "Grey-headed Bullfinch(灰头灰雀)",
    ...
    "Golden-naped Finch": "Golden-naped Finch(金枕黑雀)",
    "Dark-breasted Rosefinch": "Dark-breasted Rosefinch(暗胸朱雀)",
    "Plain Mountain Finch": "Plain Mountain Finch(林岭雀)",
    "Brandt's Mountain Finch": "Brandt's Mountain Finch(高山岭雀)",
    "Asian Rosy Finch": "Asian Rosy Finch(粉红腹岭雀)",
    "Grey-crowned Rosy Finch": "Grey-crowned Rosy Finch(灰头岭雀)",
    ...
    "Siberian Long-tailed Rosefinch": "Siberian Long-tailed Rosefinch(长尾雀)",
    "Chinese Long-tailed Rosefinch": "Chinese Long-tailed Rosefinch(中华长尾雀)",
    ...
    "Bonin Greenfinch": "Bonin Greenfinch(小笠原金翅雀)",
    ...
    "Socotra Golden-winged Grosbeak": "Socotra Golden-winged Grosbeak(金翅锡嘴雀)",
    "Arabian Golden-winged Grosbeak": "Arabian Golden-winged Grosbeak(阿拉伯锡嘴雀)",
    "Somali Golden-winged Grosbeak": "Somali Golden-winged Grosbeak(索马里锡嘴雀)",
    ...
    "Yellow-rumped Seedeater": "Yellow-rumped Seedeater(黄腰丝雀)",
    "Reichenow's Seedeater": "Reichenow's Seedeater(肯尼亚黄腰丝雀)",
    "Arabian Serin": "Arabian Serin(绿腰丝雀)",
    "Yellow-throated Seedeater": "Yellow-throated Seedeater(黄喉丝雀)",
    "Salvadori's Seedeater": "Salvadori's Seedeater(萨氏丝雀)",
    "Lemon-breasted Canary": "Lemon-breasted Canary(黄胸丝雀)",
    ...
    "Twite": "Twite(黄嘴朱顶雀)",
    "Common Linnet": "Common Linnet(赤胸朱顶雀)",
    ...
    "Two-barred Crossbill": "Two-barred Crossbill(白翅交嘴雀)",
    ...
    "White-lored Euphonia": "White-lored Euphonia(金腹歌雀)",
    "White-vented Euphonia": "White-vented Euphonia(白臀歌雀)",
    "Green-chinned Euphonia": "Green-chinned Euphonia(绿喉歌雀)",
    ...
    "Jankowski's Bunting": "Jankowski's Bunting(栗斑腹鹀)",
    "Grey-necked Bunting": "Grey-necked Bunting(灰颈鹀)",
    ...
    "Grey Bunting": "Grey Bunting(灰鹀)",
    "Pallas's Reed Bunting": "Pallas's Reed Bunting(苇鹀)",
    "Ochre-rumped Bunting": "Ochre-rumped Bunting(红颈苇鹀)",
    "Common Reed Bunting": "Common Reed Bunting(芦鹀)",
    "Tanager Finch": "Tanager Finch(拟唐纳雀)",
    "Yellow-throated Chlorospingus": "Yellow-throated Chlorospingus(黄喉丛唐纳雀)",
    "Yellow-whiskered Chlorospingus": "Yellow-whiskered Chlorospingus(短嘴丛唐纳雀)",
    ...
    "Grey-browed Brushfinch": "Grey-browed Brushfinch(灰眉薮雀)",
    ...
    "Maranon Sparrow": "Maranon Sparrow(马谷金肩雀)",
    ...
    "Sooty Fox Sparrow": "Sooty Fox Sparrow(黑狐色雀鹀)",
    "Slate-colored Fox Sparrow": "Slate-colored Fox Sparrow(灰狐色雀鹀)",
    "Thick-billed Fox Sparrow": "Thick-billed Fox Sparrow(厚嘴狐色雀鹀)",
    "Red Fox Sparrow": "Red Fox Sparrow(狐色雀鹀)",
    ...
    "Prevost's Ground Sparrow": "Prevost's Ground Sparrow(普氏地雀)",
    ...
    "Merida Brushfinch": "Merida Brushfinch(东白须薮雀)",
    ...
    "Tricolored Brushfinch": "Tricolored Brushfinch(三色薮雀)",
    "Slaty Brushfinch": "Slaty Brushfinch(灰蓝薮雀)",
    "Taczanowski's Brushfinch": "Taczanowski's Brushfinch(暗灰薮雀)",
    ...
    "Grey-eared Brushfinch": "Grey-eared Brushfinch(灰耳薮雀)",
    ...
    "Grey-crowned Palm-tanager": "Grey-crowned Palm-tanager(灰顶长尾唐纳雀)",
    ...
    "Mexican Cacique": "Mexican Cacique(黄翅酋长鹂)",
    ...
    "Solitary Cacique": "Solitary Cacique(黑酋长鹂)",
    ...
    "Scarlet-rumped Cacique": "Scarlet-rumped Cacique(橙腰酋长鹂)",
    "Subtropical Cacique": "Subtropical Cacique(亚热带酋长鹂)",
    ...
    "Bronze-brown Cowbird": "Bronze-brown Cowbird(铜褐牛鹂)",
    ...
    "Colombian Mountain Grackle": "Colombian Mountain Grackle(山拟鹩哥)",
    "Golden-tufted Mountain Grackle": "Golden-tufted Mountain Grackle(金簇山拟鹩哥)",
    ...
    "Greyish Baywing": "Greyish Baywing(栗翅牛鹂)",
    ...
    "Grey-crowned Yellowthroat": "Grey-crowned Yellowthroat(灰冠黄喉地莺)",
    "Masked Yellowthroat": "Masked Yellowthroat(黑颊黄喉地莺)",
    "Chiriqui Yellowthroat": "Chiriqui Yellowthroat(巴拿马黄喉地莺)",
    ...
    "American Yellow Warbler": "American Yellow Warbler(美洲黄林莺)",
    "Mangrove Warbler": "Mangrove Warbler(黄林莺)",
    ...
    "Myrtle Warbler": "Myrtle Warbler(黄腰白喉林莺)",
    "Audubon's Warbler": "Audubon's Warbler(奥杜邦林莺)",
    "Goldman's Warbler": "Goldman's Warbler(中美林莺)",
    ...
    "Black-throated Grey Warbler": "Black-throated Grey Warbler(黑喉灰林莺)",
    ...
    "White-rimmed Warbler": "White-rimmed Warbler(白眉王森莺)",
    ...
    "Roraiman Warbler": "Roraiman Warbler(亚马孙王森莺)",
    "Choco Warbler": "Choco Warbler(乔科王森莺)",
    "Cuzco Warbler": "Cuzco Warbler(金腹王森莺)",
    "White-lored Warbler": "White-lored Warbler(白眼先王森莺)",
    "Grey-throated Warbler": "Grey-throated Warbler(灰喉王森莺)",
    "Grey-and-gold Warbler": "Grey-and-gold Warbler(灰黄王森莺)",
    "Russet-crowned Warbler": "Russet-crowned Warbler(褐冠王森莺)",
    "Grey-headed Warbler": "Grey-headed Warbler(灰头王森莺)",
    ...
    "Black-eared Warbler": "Black-eared Warbler(黑耳王森莺)",
    ...
    "Painted Whitestart": "Painted Whitestart(彩鸲莺)",
    "Slate-throated Whitestart": "Slate-throated Whitestart(暗喉鸲莺)",
    "Brown-capped Whitestart": "Brown-capped Whitestart(褐顶鸲莺)",
    "Yellow-crowned Whitestart": "Yellow-crowned Whitestart(黄顶鸲莺)",
    "White-fronted Whitestart": "White-fronted Whitestart(白额鸲莺)",
    "Golden-fronted Whitestart": "Golden-fronted Whitestart(金额鸲莺)",
    "Spectacled Whitestart": "Spectacled Whitestart(黑头鸲莺)",
    "Collared Whitestart": "Collared Whitestart(黑领鸲莺)",
    "Paria Whitestart": "Paria Whitestart(黄脸鸲莺)",
    "White-faced Whitestart": "White-faced Whitestart(白脸鸲莺)",
    "Guaiquinima Whitestart": "Guaiquinima Whitestart(橙胸鸲莺)",
    "Tepui Whitestart": "Tepui Whitestart(泰普鸲莺)",
    ...
    "Tooth-billed Tanager": "Tooth-billed Tanager(齿嘴丽唐纳雀)",
    "Red Tanager": "Red Tanager(南暗红丽唐纳雀)",
    "Hepatic Tanager": "Hepatic Tanager(暗红丽唐纳雀)",
    ...
    "Grey-throated Chat": "Grey-throated Chat(灰喉䳭莺)",
    ...
    "Pampa Finch": "Pampa Finch(大南美草鹀)",
    "Serra Finch": "Serra Finch(南美草鹀)",
    ...
    "Grey-winged Inca Finch": "Grey-winged Inca Finch(灰翅印加雀)",
    ...
    "Orinoco Saltator": "Orinoco Saltator(白眉舞雀)",
    "Green-winged Saltator": "Green-winged Saltator(绿翅舞雀)",
    "Cinnamon-bellied Saltator": "Cinnamon-bellied Saltator(棕腹灰背舞雀)",
    "Olive-grey Saltator": "Olive-grey Saltator(暗绿舞雀)",
    "Bluish-grey Saltator": "Bluish-grey Saltator(灰背舞雀)",
    ...
    "Grey Warbler-Finch": "Grey Warbler-Finch(灰喉莺雀)",
    ...
    "Espanola Cactus Finch": "Espanola Cactus Finch(大仙人掌地雀)",
    ...
    "Grey-headed Tanager": "Grey-headed Tanager(灰头唐纳雀)",
    ...
    "Grey Pileated Finch": "Grey Pileated Finch(红顶雀)",
    "Red Pileated Finch": "Red Pileated Finch(红冠雀)",
    ...
    "Lemon-rumped Tanager": "Lemon-rumped Tanager(橙腰厚嘴唐纳雀)",
    ...
    "Huallaga Tanager": "Huallaga Tanager(黑腹厚嘴唐纳雀)",
    ...
    "Grey Seedeater": "Grey Seedeater(灰食籽雀)",
    ...
    "Grey-hooded Bush Tanager": "Grey-hooded Bush Tanager(灰头薮唐纳雀)",
    ...
    "Grey-capped Hemispingus": "Grey-capped Hemispingus(灰顶拟雀)",
    "Black-capped Hemispingus": "Black-capped Hemispingus(黑顶拟雀)",
    "White-browed Hemispingus": "White-browed Hemispingus(白眉黑顶拟雀)",
    ...
    "Western Hemispingus": "Western Hemispingus(北拟雀)",
    "Piura Hemispingus": "Piura Hemispingus(南拟雀)",
    ...
    "Grey-throated Warbling Finch": "Grey-throated Warbling Finch(灰喉歌鹀)",
    ...
    "Grey-hooded Sierra Finch": "Grey-hooded Sierra Finch(灰头岭雀鹀)",
    ...
    "Streaked Dacnis": "Streaked Dacnis(纹锥嘴雀)",
    ...
    "Golden-eyed Flowerpiercer": "Golden-eyed Flowerpiercer(蓝刺花鸟)",
    ...
    "Grey-bellied Flowerpiercer": "Grey-bellied Flowerpiercer(乌背刺花鸟)",
    ...
    "Santa Marta Mountain Tanager": "Santa Marta Mountain Tanager(黑颊岭裸鼻雀)",
    ...
    "Grey-crested Finch": "Grey-crested Finch(灰冠雀鹀)",
    "Black-crested Finch": "Black-crested Finch(黑冠雀鹀)",
    "Shrike-like Tanager": "Shrike-like Tanager(白斑唐纳雀)",
    ...
    "Grey-and-gold Tanager": "Grey-and-gold Tanager(灰黄靓唐纳雀)",
    "Blue-grey Tanager": "Blue-grey Tanager(灰蓝裸鼻雀)",
    ...
    "Silver-backed Tanager": "Silver-backed Tanager(银背靓唐纳雀)",
    "Sira Tanager": "Sira Tanager(希拉靓唐纳雀)",
    "Straw-backed Tanager": "Straw-backed Tanager(绿喉靓唐纳雀)",
